...
class Main {
  static main {
    ...
    let r3 = Ref.Ref.at(1, 1)
    let r4 = Ref.Ref.full(1, 1, true, true)
    System.print("Ref.at(1,1) == Ref.full(1,1,true,true) = " + (r3 == r4).toString)
    System.print("")

    /// Test Ref offset
    let r5 = Ref.Ref.at(2, 3)
    let r6 = r5.offset(1, 2)
    System.print("Ref(2,3).offset(1,2) = " + r6.col.toString + "," + r6.row.toString)
    System.print("")

    /// Test Cell
    let lit = Cell.LiteralCell.of(Value.CellNum.of(42))
    ...
    let cell1 = Cell.LiteralCell.of(Value.CellNum.of(5))
    ...
    /// Test RefRange
    let range = RefRange.RefRange.fromTo(Ref.Ref.at(1, 1), Ref.Ref.at(2, 2))
