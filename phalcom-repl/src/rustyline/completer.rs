...
impl Helper for PhalcomCompleter {}

impl Validator for PhalcomCompleter {}

impl Highlighter for PhalcomCompleter {}
...
/// Collect identifiers visible at module/global level.
/// (Start with module globals + class names; extend as needed.)
...
/// Member completion. Start simple: if you can’t evaluate `receiver`,
/// expose a few common members for core types (String, List, Map, Number).
