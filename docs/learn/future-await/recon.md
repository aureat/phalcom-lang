...
| Does DEC-FUT-SCHED have a `docs/decisions/` entry that supersedes plan.md? | No — `grep -rl DEC-FUT-SCHED docs/decisions/` is empty; the ruling lives only in `plan.md` §9. Stated as such. |
