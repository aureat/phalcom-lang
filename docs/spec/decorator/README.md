...
- Authority relationships:
  - [`docs/spec/v0.2/decorators/`](../v0.2/decorators/README.md) — **as-built**
    records. Those files are authoritative for what HEAD does; this tree cites
    them and never contradicts them silently.
  - [`docs/spec/v0.2/experimental/annotations-*.md`](../v0.2/experimental/annotations-core.md)
    — the mechanism drafts (registry, grammar, phases). Ratified for the
    Compile/Layout tier by ADR-0054 §1.
  - [`docs/spec/v0.2/drafts/decorators-*.md`](../v0.2/drafts/decorators-stdlib.md)
  ...
  - ADRs 0052/0053/0054/0057/0063 and PDR-0001 — the decision floor this tree
    verifies against. `docs/adr/` is frozen; new rulings go to `docs/decisions/`
    as PDRs.
