# Core Library Specification (`docs/spec/current/core/`)
...
**Current baseline — post-U-STRING, plus `Fiber` admitted to the census** (core-library
track U-CORE-1..6 complete, plus the post-U-CORE floor amendments U-COLLTYPES, U-ERR, U15,
U16-Open, U-SCHED, U-ANNOT-CONTRACTS, M-ATTR-ROOT, U-GC and U-STRING; `Fiber`'s 11 bindings
audited 2026-07-15 — a bookkeeping correction, not an amendment).
