...
- Status: **Draft — PROMOTED 2026-07-20.** The normative surface is
  [`../stdlib/bytes.md`](../stdlib/bytes.md), ruled by
  [PDR-0011](../../../pdr/0011-admit-bytes-native-octet-buffer.md) (Accepted). This
...
> flagged that `docs/spec/current/core/floor-census.md` was stale in two places at once
