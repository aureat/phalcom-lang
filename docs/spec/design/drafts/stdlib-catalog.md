...
Ratified surface: [PDR-0020](../../../pdr/0020-bitwise-operations-on-int.md). `ushr`
...
`docs/spec/current/system.md:75`: "U-SCHED deliberately splits the ready-queue from timers
...
planned per-module spec files — lives in **[`docs/spec/current/stdlib/README.md`](../stdlib/README.md)**.
...
The program in `docs/spec/current/stdlib/README.md` reflects the corrected split.
