# `docs/spec/v0.2/drafts/` — the exploration tier
...
| **Normative spec** | `docs/spec/v0.2/*.md` | The designed surface. Cites the ADR that ratified it. |
| **As-built** | `docs/spec/v0.2/decorators/`, `docs/forge/units/*/as-built.md` | What actually shipped, with `file:line` evidence. |
| **Draft** ← *you are here* | `docs/spec/v0.2/drafts/` | **Exploration.** No authority. May contradict itself. May be wrong. |
...
3. The normative surface moves to `docs/spec/v0.2/`; the as-built record follows once a
   unit lands it.
