...
- **Realizes:** [ADR-0012](../../../../adr/0012-selector-signature-encoding-and-dispatch.md) (amendment — adds the `Variadic` signature kind and `(*)` selector spelling); spec [messages-and-selectors.md §4](../../messages-and-selectors.md)
