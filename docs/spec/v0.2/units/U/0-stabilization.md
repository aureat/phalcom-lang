...
- **Realizes:** the verification gate every later forge phase depends on; spec [§implementation-status](../../implementation-status.md), [object-model §6 step 7](../../object-model.md).
...
- **`phalcom-core/tests/invariants.rs`** — the object-model / metaclass-tower invariant harness (exercised end-to-end via a real `VM`); see [U2](2-metaclass-tower.md), which populated it.
