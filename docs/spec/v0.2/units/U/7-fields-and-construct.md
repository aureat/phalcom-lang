...
- **Realizes:** [ADR-0011](../../../../adr/0011-static-instance-slot-layout.md) (static per-class instance slot layout), [ADR-0017](../../../../adr/0017-class-side-stored-static-fields.md) (class-side stored static fields, DEC-D); spec [classes §1](../../classes.md) (Constructors), [classes §2](../../classes.md) (Fields), [object-model §5](../../object-model.md) (metaclass tower). Reuses U6's private `Value::Nil` sentinel + surfacing helper.
...
- **Precluded (acceptable per ADR-0011/0017, good for a future inline cache):** adding a field
  ...
  by policy but left implementable → [deferred-work §1](../../deferred-work.md) (ADR-0026).
...
## Sources
- Forge: [U7-plan.md](../../../../forge/U7-plan.md), [STATE.md](../../../../forge/STATE.md) "U7 — LANDED".
