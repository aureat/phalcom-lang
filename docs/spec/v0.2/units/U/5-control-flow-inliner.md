...
- **`repeat(_:)` deferred** — its receiver/semantics are unpinned (U5-plan BD-U5-2); only `whileTrue(_:)` is the inlinable loop selector. See [`docs/forge/phase-next/DEFERRED.md`](../../../../forge/phase-next/DEFERRED.md) and [deferred-work.md](../../deferred-work.md).

## Sources
- Forge work order (`U5-plan.md`) folded into this spec (see git history); landing record: [`docs/forge/archive/phase2/STATE.md`](../../../../forge/archive/phase2/STATE.md) "U5 — LANDED"; DEC-E in [`docs/forge/archive/phase2/PHASE2-INDEX.md`](../../../../forge/archive/phase2/PHASE2-INDEX.md) §4.
