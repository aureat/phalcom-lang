...
> role), §5 (parallel rule); [`decisions.md`](../../core/decisions.md) **Q1** (hash is a
> floor primitive) + **§4.1** (Method re-parent); [`catalog-delta.md`](../../core/catalog-delta.md)
> §2.1 / §4.5; [`floor-census.md`](../../core/floor-census.md) §2.1 / §2.2 / §7;
> [`invariant-requirements.md`](../../core/invariant-requirements.md) R-INV-0.1…0.4,
> R-INV-1.1…1.6; [`forward-compat.md`](../../core/forward-compat.md) §1 / §3 / §4;
> [`pending-retirement.md`](../../core/pending-retirement.md) §4;
...
| Claim | Source |
|---|---|
| `hash` is a floor primitive; ADR-0019 amendment | [`decisions.md`](../../core/decisions.md) Q1; [ADR-0019](../../../../adr/0019-freeze-vm-blessed-primitive-floor.md) §1 |
| `isA`/`hash` on `Object`; `Behavior` adds `name`/`methods` | [`object-model.md`](../../object-model.md) §8, §4 |
| `class`/`superclass` already floor (⇒ `isA` derivable) | [`floor-census.md`](../../core/floor-census.md) §2.1/§2.2; `universe.rs` L241/L269 |
| `Object#name` returns metaclass name for a class receiver | `primitive/object.rs::object_name` L23; `value.rs::class` L94 |
| `Method < Function` re-parent + load order | [`decisions.md`](../../core/decisions.md) §4.1; [ADR-0006](../../../../adr/0006-function-as-abstract-callable-root.md); `universe.rs` L147–149; [`bootstrap-phases.md`](../../core/bootstrap-phases.md) §2.1 step 5 |
| R-INV-0.1…0.4, 1.1…1.6 | [`invariant-requirements.md`](../../core/invariant-requirements.md) §3–§4 |
| parallel rule (all rows) | [ADR-0002](../../../../adr/0002-metaclass-tower-parallel-rule.md); `verify_invariants` L472 |
| `Number#hash` by mathematical value; Value openness; module scoping | [`forward-compat.md`](../../core/forward-compat.md) §4/§1/§3 |
| pending flips | [`pending-retirement.md`](../../core/pending-retirement.md) §3–§4 |
