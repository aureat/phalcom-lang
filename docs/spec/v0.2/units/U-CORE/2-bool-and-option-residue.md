...
> **U-CORE-2 amendment**; [`catalog-delta.md`](../../core/catalog-delta.md) §2.2 / §4.2;
> [`decisions.md`](../../core/decisions.md) Q2 / §4.4; [`floor-census.md`](../../core/floor-census.md)
> §2.6 / §2.8; [`invariant-requirements.md`](../../core/invariant-requirements.md) R-INV-2.1–2.4,
> R-INV-0.3; [`forward-compat.md`](../../core/forward-compat.md) §2.
...
1. **`Bool#ifTrue(_)` / `ifFalse(_)` now return a well-formed `Option`.** The
   *taken* arm is `Some`-lifted; the *untaken* arm is the `None` singleton — so
   ...
   (`A ∪ None`). This closes [`catalog-delta.md`](../../core/catalog-delta.md) §4.2.
...
| Item | Owner | Anchor |
|---|---|---|
| `None#toString` / `Some#toString` surface (the `toString` **message**) | **U-CORE-4** | [`decisions.md`](../../core/decisions.md) §4.4 |
| `Option#ifSome(_)`, `map(_)`, `flatMap(_)`, `filter(_)`, `unwrapOr(_)`, `unwrapOrElse(_)`, `unwrap()`, `zip(_)`, `contains(_)` | **U-STD** | [`catalog-delta.md`](../../core/catalog-delta.md) §2.2 |
...
> [`decisions.md`](../../core/decisions.md) §4.4, which assigns per-type `toString`
...
Per [`floor-census.md`](../../core/floor-census.md) §2.6 / §2.8, the relevant floor is
...
[`pending-retirement.md`](../../core/pending-retirement.md) §4, U-CORE-2 flips **no
...
[`invariant-requirements.md`](../../core/invariant-requirements.md) §1 (user-observable
...
([`catalog-delta.md`](../../core/catalog-delta.md) §4.2; ADR-0018 amendment).
...
- **Boot half** (`verify_invariants`): the `None` singleton is a live value
  ...
  ([`invariant-requirements.md`](../../core/invariant-requirements.md) §3, R-INV-0.3).
...
Per [`forward-compat.md`](../../core/forward-compat.md) §5, U-CORE-2's applicable section
...
Consistent with [`decisions.md`](../../core/decisions.md) Q2 (confirm ADR-0008; U-CORE-6
