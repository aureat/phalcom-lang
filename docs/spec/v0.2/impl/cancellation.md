...
> [PDR-0017](../../../decisions/0017-future-cancel-is-renunciation.md) (Proposed —
> rule 5). Dispatch-ready otherwise. Surface contract
> [`../core/cancellation.md`](../core/cancellation.md); substrate contract
> [`../core/reactor.md`](../core/reactor.md) §3/§7.
...
- `cancel()` exactly as [`../core/cancellation.md`](../core/cancellation.md) §3 —
...
[`../core/cancellation.md`](../core/cancellation.md) §6's harness row for row in
