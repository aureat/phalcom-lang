...
> role), §5 (parallel rule); [`decisions.md`](./decisions.md) **Q1** (hash is a
> floor primitive) + **§4.1** (Method re-parent); [`catalog-delta.md`](./catalog-delta.md)
> §2.1 / §4.5; [`floor-census.md`](./floor-census.md) §2.1 / §2.2 / §7;
