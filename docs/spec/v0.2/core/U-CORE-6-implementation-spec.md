...
| **U-CORE-0** | Q2 ruling (confirm ADR-0008, do not redesign), the census, the invariant ledger, the forward-compat gate. | [`decisions.md`](./decisions.md) §Q2, [`floor-census.md`](./floor-census.md), [`invariant-requirements.md`](./invariant-requirements.md) §U-CORE-6, [`forward-compat.md`](./forward-compat.md) §2 |
...
Per [`decisions.md`](./decisions.md) §Q2 and [ADR-0008](../../../adr/0008-layered-exceptions-and-result.md),
...
[catalog-delta.md](./catalog-delta.md) §2.7 marks all six ❌/❌).
...
### `_pending` fixtures this unit relates to ([pending-retirement.md](./pending-retirement.md) §4)
...
### Invariants this unit adds ([invariant-requirements.md](./invariant-requirements.md) §U-CORE-6)
...
| **6.5** | Floor census (R-INV-0.1) updated in lockstep for the `message`/`raise` additions. | **C** | Bump the census audit's expected binding count **73 → 75** and add the two `(Error, selector)` rows; amend [`floor-census.md`](./floor-census.md) §2 + §1.1 in the same change. |

**Boot vs corpus:** 6.1 → **H + C**; 6.2/6.3/6.4/6.5 → **C**.

---

## §5. Must-not-preclude ([forward-compat.md](./forward-compat.md) §2 — *the* section — + §1)
...
model, and [`decisions.md`](./decisions.md) §Q2 confirms it.
...
> [`floor-census.md`](./floor-census.md) §1.1/§2 and the R-INV-0.1 audit in the same
> change.
...
|---|---|
| Confirm ADR-0008; U-CORE-6 = minimal reification | [`decisions.md`](./decisions.md) §Q2; [ADR-0008](../../../adr/0008-layered-exceptions-and-result.md) |
...
| dNU/`Message` reification the raise wires to | [floor-census.md](./floor-census.md) §2.14; [catalog-delta.md](./catalog-delta.md) §2.7/§4.5 |
| Invariants R-INV-6.1…6.5 | [invariant-requirements.md](./invariant-requirements.md) §U-CORE-6 |
| Must-not-preclude (errors + fibers) | [forward-compat.md](./forward-compat.md) §2, §1 |
| Fixtures `errors_throw_try_catch_finally` / `errors_result_bridge` | [pending-retirement.md](./pending-retirement.md) §4 |
