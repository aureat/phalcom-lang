...
> [PDR-0017](../../../decisions/0017-future-cancel-is-renunciation.md)** (rule 5: no
...
[`../impl/reactor.md`](../impl/reactor.md) §1 architecture holds with zero exceptions.
...
- **`#closed` settlement on resource close** — PDR-0015 ruling 8 / core/net.md §7
  (close semantics, not cancellation).
- **Interrupting workers, cancelling fibers, undoing effects** — §1's "never" clause
  and Q-C2.
- **Implementation seams** — [`../impl/cancellation.md`](../impl/cancellation.md)
  (U-CANCEL).
