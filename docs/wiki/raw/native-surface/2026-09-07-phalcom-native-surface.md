# Phalcom Native Surface source snapshot

> Source: Local repository snapshot at `phalcom-native-surface/`
> Collected: 2026-09-07
> Published: Unknown

> Note: `generated.rs` is represented by its generated header excerpt; the full generated catalog remains in the source directory.

## `phalcom-native-surface/Cargo.toml`

~~~~toml
[package]
name = "phalcom-native-surface"
version = "0.1.0"
edition = "2024"
description = "VM-free canonical native member descriptors shared by Phalcom runtime and tooling."

[lib]
name = "phalcom_native_surface"
path = "src/lib.rs"
[dependencies]
