# Raw source snapshot: module topology

> Captured: 2026-09-08
> Source area: normative module specification and MODL001 program boundary

--- docs/spec/current/modules.md ---
# Modules & Imports
...
--- docs/implementation/MODL001-module-architecture/PROGRAM.md ---
---
id: MODL001
category: MODL
...
# MODL001 — module architecture

This program owns module, package, project-model, linking, initialization, and
module-aware LSP architecture. It includes corrective plans and handoffs that
continue the same module architecture checkpoint.
