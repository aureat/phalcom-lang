...
- Status: **Accepted** (mandate ruled by the user 2026-07-20, this session; §1–§2
  ...
  the v0.3 track)
- Date: 2026-07-20
- Related: [`docs/spec/decorator/`](../spec/decorator/README.md) (the canonical
...
The decorator corpus was consolidated 2026-07-20 into `docs/spec/decorator/`
...
`docs/spec/decorator/`; the as-built files under `docs/spec/v0.2/decorators/`
...
- reactive.md's preclusion "`@effect` before R-5" — **replaced**: the
  ...
  ([effect.md](../spec/decorator/effect.md)) rather than waiting for
...
- frameworks.md's "nothing here is scheduled" — the families receive a
  concrete experimental design ([frameworks-design.md](../spec/decorator/frameworks-design.md))
...
Four design specs land with this record under `docs/spec/decorator/`,
**experimental**: normative for the v0.3 track once reviewed, binding nothing
in v0.2:

| Spec | Designs |
|---|---|
| [runtime-tier.md](../spec/decorator/runtime-tier.md) | `Invocation`, `proceed`, chain composition and caching, the ADR-0053 guard bit, per-fiber trace-bypass, deopt and erasure obligations |
| [dispatch-tier.md](../spec/decorator/dispatch-tier.md) | `resolveMissing(_)` protocol, transient (non-installing) resolution, chaining, dNU interaction, `@ForwardMissing(to:)` |
| [effect.md](../spec/decorator/effect.md) | `@effect` with explicit activation, `Effect` handles, scope-owned disposal (no finalizers — PDR-0005 constraint honored) |
| [frameworks-design.md](../spec/decorator/frameworks-design.md) | experimental rulings for E-1…E-4 and W-1…W-3; `T.schema` reflective contract; the request pipeline as fixture |
...
candidate in [proposals.md](../spec/decorator/proposals.md).
