# TDR-0069 — Numeric tower residue: `~/` is total over the tower and returns `Int`; construction never narrows; the `Bool` arm dies

- Legacy record: `PDR-0025`
- Ratified: 2026-07-21

- Status: **Accepted** (ratified 2026-07-21)
- Discharges: [TDR-0064](./0064-numeric-tower-implementation-and-floor-amendment.md) open
...
- Related: [TDR-0022](./0022-numeric-surface-split-int-float-and-division.md)
  ...
  [TDR-0019](./0019-no-truthiness-enforcement.md) (the posture ruling 4's
  discovery offends), [TDR-0068](./0068-bitwise-operations-on-int.md) (`>> ≡ ~/ 2ⁿ` inherits
