# TDR-0042 — Invariant re-entrancy is receiver-scoped; per-receiver decorator state is Layout-confined

- Legacy record: `ADR-0052`
- Ratified: 2026-07-13

- Status: Accepted
- Date: 2026-07-13
- Related: [TDR-0007](./0007-layered-exceptions-and-result.md) (unwind primitive —
  `ensure` fires on any unwind), [TDR-0008](./0008-handle-arena-heap.md)
  (handle/arena heap, `Copy` `ObjRef`), [TDR-0010](./0010-static-instance-slot-layout.md)
  (fixed per-class slot layout), [TDR-0012](./0012-closure-upvalues-and-frame-token-return.md)
  (non-local return / unwind), [TDR-0047](./0047-non-moving-mark-sweep-collector.md)
  (mark-sweep collector), `docs/spec/current/experimental/annotations-contract-semantics.md`
...
works directly against the mark-sweep collector ([TDR-0047](./0047-non-moving-mark-sweep-collector.md)):
...
is cheap — `ObjRef` is already `Copy`/hashable ([TDR-0008](./0008-handle-arena-heap.md)),
...
([TDR-0007](./0007-layered-exceptions-and-result.md) /
[TDR-0012](./0012-closure-upvalues-and-frame-token-return.md) — `return`/`throw`/
...
> for the truthiness ban ([TDR-0019](./0019-no-truthiness-enforcement.md),
...
- **Positive.** `@computed`, and any future per-receiver builtin decorator,
  ...
  mark-sweep collector ([TDR-0047](./0047-non-moving-mark-sweep-collector.md))
...
uses. [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md) §4's
