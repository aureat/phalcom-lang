# TDR-0067 — Decorator governance: ADR carry-forward verified; Install/Dispatch/Runtime tiers, `@effect`, and the framework families mandated as the v0.3 experimental track

- Legacy record: `PDR-0018`
- Ratified: 2026-07-20
...
- Related: [`docs/design/decorators/canonical/`](../design/decorators/canonical/README.md) (the canonical
  ...
  [TDR-0042](./0042-invariant-reentrancy-scope-and-layout-confined-decorator-state.md),
  [TDR-0043](./0043-runtime-decorator-interception-reuses-override-epoch-guard.md),
  [TDR-0044](./0044-two-speed-ratification-annotation-decorator-tiers.md),
  [TDR-0045](./0045-decorator-granularity-vs-proxy-granularity-split.md),
  [TDR-0051](./0051-constructors-are-ordinary-class-side-methods.md)
  (decorator surface: `@constructor`/`@class`),
  [TDR-0046](./0046-reactive-tracking-context-needs-a-native-module.md)
  (`Reactive` native module — `@effect`'s substrate),
  [TDR-0053](./0053-classes-are-closed.md) (closure; composes with A-5's frozen
  retention), [TDR-0057](./0057-resources-are-disposable-handles-not-finalized.md)
...
These ADRs are **not** superseded by this record; `docs/decisions/README.md` is
