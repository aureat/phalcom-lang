# TDR-0024 — Amend the frozen floor — admit the `Method` reflection surface

- Legacy record: `ADR-0028`
- Ratified: 2026-07-12
...
- Date: 2026-07-12
- Related: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (frozen floor,
  amended here); [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md)
  ...
  [TDR-0005](./0005-function-as-abstract-callable-root.md) (`Function` root,
  `Method`/`Block` siblings); [TDR-0012](./0012-closure-upvalues-and-frame-token-return.md)
  (frame-token non-local return, re-entered by `invoke_method_object`);
  [TDR-0009](./0009-tagged-value-enum.md) (closed `Value` enum, untouched here);
