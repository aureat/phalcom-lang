# TDR-0064 — The numeric tower lands: `Int`/`Float` implementation rulings and the floor amendment (137 → 153)

- Legacy record: `PDR-0012`
- Ratified: 2026-07-20
...
- Date: 2026-07-20
- Amends: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (the floor
  freeze — `docs/decisions/` is frozen, so the amendment is carried here, the way ADR-0039/ADR-0049
  carried theirs when that folder was live, and the way [TDR-0063](./0063-admit-bytes-native-octet-buffer.md)
  ruling 3 carries its own)
- Related: [TDR-0022](./0022-numeric-surface-split-int-float-and-division.md)
  ...
  [TDR — Keep a single flat `Number` type backed by `f64`](../retired/number-as-flat-f64.md) (its `f64` survives as `Float`'s
  representation), [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md)
  (value-based `hash`; R-INV-1.3 is what ruling 10 protects),
  [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md) (the inliner
  whose hardening ruling 17 orders against),
  [TDR-0008](./0008-handle-arena-heap.md) / [TDR-0009](./0009-tagged-value-enum.md)
  (the heap and `Value` this widens),
  [TDR-0053](./0053-classes-are-closed.md) (reserved kernel names — ruling 15),
  [TDR-0063](./0063-admit-bytes-native-octet-buffer.md) (**also amends ADR-0019**; the two
  compose — ruling 14)
...
3. **The per-class split doubles the numeric floor** (14 → 30), which under ADR-0019's one-way
   ...
   protocol; `docs/decisions/` is frozen, so it is carried here.
...
22. **Kernel-name reservation is inherited, not built here.** [TDR-0053](./0053-classes-are-closed.md)
...
> **Q-1 and Q-2 are discharged by [TDR-0069](./0069-numeric-tower-residue-rulings.md)** (Accepted,
