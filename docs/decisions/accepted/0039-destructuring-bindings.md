# TDR-0039 — Destructuring `let`/`var` bindings — irrefutable tuple + list, `at(_)` protocol

- Legacy record: `ADR-0046`
- Ratified: 2026-07-13
...
- Related: `docs/spec/current/open-questions.md` Q7; `docs/decisions/retired/let-and-var-bindings.md
  (the base `let`/`var` binding this extends); `docs/decisions/accepted/0018-kernel-list-native-array-protocol.md
  (`at(_)` — the accessor this reuses); `docs/decisions/accepted/0028-collections-representation-and-literals.md (the `(a,b)`/
  `[…]` collection-literal grammar this reuses in pattern position);
  `docs/decisions/accepted/0033-amend-floor-admit-collection-container-primitives.md (native
