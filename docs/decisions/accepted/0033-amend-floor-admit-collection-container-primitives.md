# TDR-0033 — Amend the frozen floor — admit collection-container primitives (`Map`/`Set`/`Tuple`/`Range`)

- Legacy record: `ADR-0039`
- Ratified: 2026-07-12
...
- Related: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (the frozen floor);
  [TDR-0028](./0028-collections-representation-and-literals.md) (native-arm representation);
  [TDR-0018](./0018-kernel-list-native-array-protocol.md) (the `List` native-array precedent);
  [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md) (amendment precedent + `hash`);
  [`collection-protocol.md`](../../spec/current/core/collection-protocol.md);
  [`../../forge/units/U-COLLTYPES/map-set-tuple-range.md`](../forge/units/U-COLLTYPES/plan.md) (DEC-CT-A)

## Context

[TDR-0028](./0028-collections-representation-and-literals.md) ratified **native heap-arm**
...
([TDR-0018](./0018-kernel-list-native-array-protocol.md)). `U-COLLTYPES/plan.md` DEC-CT-A
enumerates the set; this ADR ratifies it.

## Decision

**Amend [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) to admit the raw
...
- **Key-hashing re-enters dispatch (load-bearing).** `Map`/`Set` must key by **Phalcom**
  ...
  [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md) restricted-yield model
...
- **`.ph`-over-`List`.** Rejected by [TDR-0028](./0028-collections-representation-and-literals.md)
