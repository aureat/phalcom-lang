# TDR-0053 — Classes are closed: remove class reopening

- Legacy record: `PDR-0001`
- Ratified: 2026-07-19

- Status: Accepted
- Date: 2026-07-19
- Supersedes: [TDR — Methods are open; superclass reparenting is sealed](../retired/class-hierarchy-mutability.md) — reverses its
  **Axis 1** ("methods are open"). Axis 2 (superclass reparenting is sealed) is kept
  unchanged and strengthened.
- Amended by: [TDR-0054](./0054-class-declarations-join-the-binding-namespace.md)
...
- Related: [TDR-0010](./0010-static-instance-slot-layout.md) (frozen slot
  offsets), [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)
