# TDR-0015 — Class-side stored static fields live on the metaclass instance

- Legacy record: `ADR-0017`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: [TDR-0010](./0010-static-instance-slot-layout.md); [TDR-0002](./0002-metaclass-tower-parallel-rule.md); [TDR-0006](./0006-option-as-abstract-with-some-none.md); [TDR-0009](./0009-tagged-value-enum.md); `docs/spec/current/classes.md` §2–3; `docs/spec/current/units/U/7-fields-and-construct.md` (DEC-D, as-built)

## Context

[TDR-0010](./0010-static-instance-slot-layout.md) fixed the *instance* field model: a
...
The design constraint is uniformity. Phalcom's tower ([TDR-0002](./0002-metaclass-tower-parallel-rule.md))
...
- The whole-class field-collection rule and **read-before-write compile error**
  ([TDR-0010](./0010-static-instance-slot-layout.md)) carry over verbatim, keyed to the
...
- An unassigned static slot reads `None`, backed by the private `Nil` sentinel
  ([TDR-0009](./0009-tagged-value-enum.md)) and surfaced via the same absence helper
  ([TDR-0006](./0006-option-as-abstract-with-some-none.md)) — the sentinel is never
...
- **Dispatch impact:** none. Static *methods/getters* already flow through
  `is_static` + metaclass dispatch ([TDR-0002](./0002-metaclass-tower-parallel-rule.md));
