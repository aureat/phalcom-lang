# TDR-0061 — The LSP-backed REPL surface waits for ADR-0056 to be ratified

- Legacy record: `PDR-0009`
- Ratified: 2026-07-20

- Status: Accepted
- Date: 2026-07-20
- Related: [TDR — Phalcom language intelligence is an in-process `phalcom-lsp` server](../proposed/phalcom-lsp-architecture.md) (**Proposed** — the
