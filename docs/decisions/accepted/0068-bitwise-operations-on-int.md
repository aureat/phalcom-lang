# TDR-0068 — Bitwise operations on `Int`: infinite two's complement, operator selectors, no wrapping

- Legacy record: `PDR-0020`
- Ratified: 2026-07-21

- Status: **Accepted** (ratified 2026-07-21)
- Amends: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (floor +10 on `Int`)
- Depends on: [TDR-0064](./0064-numeric-tower-implementation-and-floor-amendment.md) and [TDR-0069](./0069-numeric-tower-residue-rulings.md); every selector here lives on unimplemented `Int`
