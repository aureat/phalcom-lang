# TDR-0066 — The diagnostics renderer is in-house; miette leaves the workspace

- Legacy record: `PDR-0014`
- Ratified: 2026-07-20
...
- Related: [`docs/spec/current/traceback/implementation-spec.md`](../spec/current/traceback/implementation-spec.md)
  ...
  drove the choice), [TDR-0062](./0062-errors-carry-structure-and-cheap-origin.md) (what errors
