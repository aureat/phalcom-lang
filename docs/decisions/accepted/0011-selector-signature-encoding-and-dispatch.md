...
- Legacy record: `ADR-0012`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/messages-and-selectors.md` §2–3; `docs/spec/current/method-lookup.md` §1; `docs/spec/current/object-model.md` §7; forge findings F1, F7, F8; [TDR-0008](./0008-handle-arena-heap.md)
...
- Dispatch is built **inline-cache-ready**: each call site owns a monomorphic cache
  ...
  ([TDR-0008](./0008-handle-arena-heap.md)). The IC *population* may be deferred, but
