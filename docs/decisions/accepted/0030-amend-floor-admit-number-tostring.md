# TDR-0030 — Amend the frozen floor — admit `Number#toString`

- Legacy record: `ADR-0036`
- Ratified: 2026-07-12
...
- Related: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (frozen
  ...
  and `Error#message`/`raise` (U-CORE-6)); [TDR-0024](./0024-amend-floor-admit-method-reflection.md)
  (sibling per-unit landing record — same amendment pattern, `Method`
  reflection slice, 80 → 85); [TDR-0013](./0013-object-default-tostring.md)
  (`Object#toString` default — re-homed, not re-bound, by this unit);
  [TDR — Keep a single flat `Number` type backed by `f64`](../retired/number-as-flat-f64.md) (`Number` as a flat `f64`, the
...
([TDR-0013](./0013-object-default-tostring.md)'s `"<ClassName>"` default plus
...
1. **`Number#toString`** — renders the receiver's `f64` value as a decimal
   ...
   (forward-compat §4, [TDR-0022](./0022-numeric-surface-split-int-float-and-division.md))
