# TDR-0029 — Iteration protocol: a Wren-style two-selector cursor

- Legacy record: `ADR-0035`
- Ratified: 2026-07-12
...
- Related: [`docs/spec/current/iteration.md`](../../spec/current/iteration.md) (the promoted
  ...
  [TDR-0006](./0006-option-as-abstract-with-some-none.md) (`Option` cursor);
  [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md) (inliner);
  [TDR-0018](./0018-kernel-list-native-array-protocol.md) (`List`);
  [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md) (generators on `Fiber`);
...
([TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md); methods are open,
[TDR — Methods are open; superclass reparenting is sealed](../retired/class-hierarchy-mutability.md)). Loops without them keep the plain
...
([TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)). Only the loop
...
([TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md) §4): a generator
