# TDR-0008 — Object graph lives in a handle/arena heap

- Legacy record: `ADR-0009`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/object-model.md` §6; `docs/spec/current/system.md` (gc); [open question Q4](../../spec/current/open-questions.md); forge finding F5; [TDR-0002](./0002-metaclass-tower-parallel-rule.md)

## Context

The kernel is a cyclic object graph: `Metaclass` is an instance of itself, and
the metaclass tower closes at the top ([Object Model §5–6](../../spec/current/object-model.md)).
...
collector: object cycles are normal, `System.gc` is specified ([System §Runtime](../../spec/current/system.md)),
and runtime `superclass=` ([open question Q4](../../spec/current/open-questions.md)) means the
...
- The bootstrap allocate-then-wire ordering ([Object Model §6](../../spec/current/object-model.md),
  [TDR-0002](./0002-metaclass-tower-parallel-rule.md)) becomes "allocate handles,
...
- **Inline-cache- and GC-ready.** Handles are stable keys, so they double as inline
  cache tags ([TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)); the
  arena is the natural home for a future tracing GC ([System §gc](../../spec/current/system.md)),
...
- **Runtime hierarchy mutability stays open.** Because links are handles patched in
  place, `superclass=` ([open question Q4](../../spec/current/open-questions.md)) remains
