# TDR-0041 — Amend iteration: bare-cursor end-sentinel + kernel `Iterable` root

- Legacy record: `ADR-0048`
- Ratified: 2026-07-13

- Status: Accepted
- Date: 2026-07-13
- Amends: [TDR-0029](./0029-iteration-protocol-cursor.md) §1 (protocol return shape) and
...
- Related: [`docs/spec/current/iteration.md`](../../spec/current/iteration.md) (normative spec);
  [TDR-0006](./0006-option-as-abstract-with-some-none.md) / [TDR-0037](./0037-option-bootstrap-formalization-and-defer-niche-encoding.md)
  (`Option`, the deferred niche); [TDR-0009](./0009-tagged-value-enum.md) (`Value`, the
  private `Nil` sentinel); [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)
  (inliner); [TDR-0018](./0018-kernel-list-native-array-protocol.md) (`List`).
...
- **The deferred `Some` niche-encoding** ([TDR-0037](./0037-option-bootstrap-formalization-and-defer-niche-encoding.md);
...
- **Keep `Some(cursor)` and niche-encode `Option` into `Value`.** Rejected for now — the
  ...
  ([TDR-0037](./0037-option-bootstrap-formalization-and-defer-niche-encoding.md)), and it
