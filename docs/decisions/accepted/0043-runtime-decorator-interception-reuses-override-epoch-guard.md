# TDR-0043 — Runtime-tier decorator interception reuses the sacred-selector override-epoch guard

- Legacy record: `ADR-0053`
- Ratified: 2026-07-13

- Status: Accepted
- Date: 2026-07-13
- Related: [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)
  (sacred-selector inliner + override-epoch deopt guard — the mechanism this
  generalizes), [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)
  (selector dispatch, inline-cache-ready design, IC population deferred),
  `docs/spec/current/decorators/README.md` (five-tier model — Runtime tier, the
  "Inline-cache invalidation" hazard this resolves), `docs/spec/current/decorators/on.md`
  (`aroundSend(_)` hook)
...
2. Whether interception reaches **sacred-selector** sends (`ifTrue`,
   `whileTrue`, `+`, …) that [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)'s
...
([TDR-0011](./0011-selector-signature-encoding-and-dispatch.md), IC population
