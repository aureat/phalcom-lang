# TDR-0021 — Amend the frozen floor — admit `hash`, kernel reflection, `Number#toString`, and `Error#message`/`raise`

- Legacy record: `ADR-0023`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Related: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (frozen floor,
  amended here); [TDR-0005](./0005-function-as-abstract-callable-root.md)
  (`Function` root); [TDR-0007](./0007-layered-exceptions-and-result.md) (layered
...
[TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) fixed a permanent
...
Adopt this **single omnibus amendment** to [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md),
