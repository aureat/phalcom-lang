# TDR-0070 — Numeric literal grammar: radix prefixes, separators, decimal exponents, no `n` suffix

- Legacy record: `PDR-0026`
- Ratified: 2026-07-21

- Status: **Accepted** (ratified 2026-07-21)
- Depends on: [TDR-0022](./0022-numeric-surface-split-int-float-and-division.md), [TDR-0064](./0064-numeric-tower-implementation-and-floor-amendment.md)
- Spec: [TDR-0070](./0070-numeric-literals.md)
