# TDR-0055 — No user-visible shared-memory threads: fibers now, isolates if ever

- Legacy record: `PDR-0003`
- Ratified: 2026-07-20

- Status: Accepted
- Date: 2026-07-20
- Related: [TDR-0008](./0008-handle-arena-heap.md) (handle/arena heap — the
  single-owner premise this ruling protects),
  [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md) (fibers as the
  sole concurrency primitive),
  [TDR-0047](./0047-non-moving-mark-sweep-collector.md) (precise root enumeration
  from per-VM state), [TDR-0056](./0056-io-is-future-shaped-reactor-owned.md) (the IO shape
...
[TDR-0056](./0056-io-is-future-shaped-reactor-owned.md), which needs a filesystem thread pool.
...
This is [ffi.md](../spec/current/drafts/ffi.md) §4's condition (c) — *the object graph never leaves
