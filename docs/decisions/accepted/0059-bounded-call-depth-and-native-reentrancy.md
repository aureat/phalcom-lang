# TDR-0059 — Bounded call depth and native re-entrancy: two counters, one error

- Legacy record: `PDR-0007`
- Ratified: 2026-07-20

- Status: Accepted
- Date: 2026-07-20
- Related: [TDR-0007](./0007-layered-exceptions-and-result.md) (terminating unwind;
  `ensure` fires on any unwind — the mechanism this error must travel),
  [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md) §4
  (`native_reentry_depth`, the existing re-entrancy guard this record generalizes),
  [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md) (why a depth
  cap does not bound loops), [TDR-0055](./0055-no-user-visible-threads-fibers-and-isolates.md)
...
Both are per-VM, and therefore per-fiber in effect: [TDR-0055](./0055-no-user-visible-threads-fibers-and-isolates.md)
