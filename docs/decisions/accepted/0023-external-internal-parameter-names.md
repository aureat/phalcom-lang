# TDR-0023 — Separate external labels from internal parameter names

- Legacy record: `ADR-0025`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Related: [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md) (label-encoded
  selectors — the label, not the binding name, is part of selector identity),
  `docs/spec/current/messages-and-selectors.md` §2–3, `docs/spec/current/selectors.md`,
  `docs/spec/current/open-questions.md` Q3, `phalcom-ast` (parser/param list), `frame.rs`
...
[TDR-0011](./0011-selector-signature-encoding-and-dispatch.md) encodes a selector as
