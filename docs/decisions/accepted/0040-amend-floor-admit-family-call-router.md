# TDR-0040 — `::` method references (Open form, callable-only); amend the frozen floor +1 (`Family#doesNotUnderstand`)

- Legacy record: `ADR-0047`
- Ratified: 2026-07-13
...
- Amends: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (the frozen floor);
  ...
  [TDR-0038](./0038-module-import-relative-path-whole-module-binding.md)
- Related: [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md) (`encode_selector`/
...
[TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) §1 derivability test for the same
