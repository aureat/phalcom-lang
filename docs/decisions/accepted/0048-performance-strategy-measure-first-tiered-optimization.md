# TDR-0048 — Performance strategy: measure-first, tiered, behavior-invariant

- Legacy record: `ADR-0051`
- Ratified: 2026-07-14
...
- Date: 2026-07-13
- Related: [TDR-0008](./0008-handle-arena-heap.md) (handle heap),
  [TDR-0009](./0009-tagged-value-enum.md) (`Value` repr; NaN-boxing deferral),
  [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md) (selector encoding;
  inline-cache seam), [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)
  (sacred-selector inliner + deopt guard), [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md)
  (fibers own heap-resident stacks), [TDR-0047](./0047-non-moving-mark-sweep-collector.md)
