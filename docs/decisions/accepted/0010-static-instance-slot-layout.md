# TDR-0010 — Instances use a static per-class slot layout

- Legacy record: `ADR-0011`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/classes.md` §2; `docs/spec/current/object-model.md` §2; [TDR-0008](./0008-handle-arena-heap.md); [TDR-0009](./0009-tagged-value-enum.md)
...
- An unassigned slot reads `None`; the private `Nil` sentinel ([TDR-0009](./0009-tagged-value-enum.md))
...
- Stable offsets are what let a call-site/field cache and a future inline cache
  ([TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)) assume a fixed
  shape per class.
