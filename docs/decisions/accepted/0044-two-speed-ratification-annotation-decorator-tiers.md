# TDR-0044 — Two-speed ratification: Compile/Layout tier now, Install/Dispatch/Runtime gated on ADR-0053

- Legacy record: `ADR-0054`
- Ratified: 2026-07-13
...
- Related: `docs/spec/current/experimental/annotations-core.md` (the original
  ...
  (open questions A-1–A-6, the remaining gate), [TDR-0043](./0043-runtime-decorator-interception-reuses-override-epoch-guard.md)
...
resolved by [TDR-0043](./0043-runtime-decorator-interception-reuses-override-epoch-guard.md),
...
- `annotations-contracts.md` + `annotations-contract-semantics.md` (as
  amended by [TDR-0042](./0042-invariant-reentrancy-scope-and-layout-confined-decorator-state.md)
...
- **(a) Runtime-tier cost model — satisfied.** [TDR-0043](./0043-runtime-decorator-interception-reuses-override-epoch-guard.md)
