# TDR-0035 — Hierarchy-stability policy: sealed reparenting + single inheritance

- Legacy record: `ADR-0041`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Related: [TDR — Methods are open; superclass reparenting is sealed](../retired/class-hierarchy-mutability.md) (prior art — already
  ships the sealed-reparent / open-methods split this ADR ratifies as unit
  policy), [TDR-0010](./0010-static-instance-slot-layout.md) (static per-class
  slot layout — the invariant sealing protects), [TDR-0015](./0015-class-side-stored-static-fields.md)
  (class-side field offsets up the tower), [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)
  (override-epoch deopt guard — reused by method reopening; the escape hatch a
  future `reshape` would reuse), [TDR-0008](./0008-handle-arena-heap.md) (handle
  heap — keeps a future reparent-with-migration implementable, so sealing now
  costs nothing later), [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)
...
Q4's decision (DEC-U13a) was **already shipped** as [TDR — Methods are open; superclass reparenting is sealed](../retired/class-hierarchy-mutability.md)
...
(the override-epoch mechanism, [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)),
...
- **A future reparent-with-migration primitive** (Q4's non-sealed option) is
  *not foreclosed* — [TDR-0008](./0008-handle-arena-heap.md)'s handle heap keeps
...
- **Stateless traits, flattened at class-finalization** (Q10's admissible
  ...
  ancestor walk (breaking [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)'s
  one-hashmap-probe dispatch) and per-instance variable state to come from
  more than one ancestor (breaking [TDR-0010](./0010-static-instance-slot-layout.md)'s
...
See [TDR — Methods are open; superclass reparenting is sealed](../retired/class-hierarchy-mutability.md) §Alternatives for Q4 (fully
