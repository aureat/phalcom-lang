# TDR-0027 — Error-handling surface syntax: `throw` / `try` / `catch` / `on` / `ensure`

- Legacy record: `ADR-0031`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Related: [TDR-0007](./0007-layered-exceptions-and-result.md) (error **model** — layered,
...
[TDR-0007](./0007-layered-exceptions-and-result.md) fixed the error **model**:
