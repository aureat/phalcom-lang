# TDR-0031 — Amend the frozen floor — admit `Error#message`/`Error#raise`

- Legacy record: `ADR-0037`
- Ratified: 2026-07-12
- Consolidation review: [DATE CONFLICT] explicit ratification date differs from the source `Date` field; chronology uses ratification.
...
- Date: 2026-07-12
- Related: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (frozen
  floor, amended here); [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md)
  ...
  (U-CORE-3), and `Number#toString` (U-CORE-4)); [TDR-0024](./0024-amend-floor-admit-method-reflection.md)
  and [TDR-0030](./0030-amend-floor-admit-number-tostring.md) (sibling per-unit
  landing records — same amendment pattern, 80 → 85 and 85 → 86 respectively);
  [TDR-0007](./0007-layered-exceptions-and-result.md) (layered exceptions/
  `Result` design — the one-unwind-primitive model this amendment realizes
  the `Raise` half of); [TDR-0027](./0027-error-handling-surface-syntax.md)
...
[TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) froze a permanent
VM-blessed primitive floor. [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md)
...
"Errors", [TDR-0007](./0007-layered-exceptions-and-result.md)). Per its as-built
...
spelled by [TDR-0027](./0027-error-handling-surface-syntax.md)) are likewise
reserved, not built here.

## Decision

Amend [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md)'s floor list to
...
2. **`Error#raise`** (`raise()`, zero-arity) — initiates the unified unwind's
   ...
   [TDR-0007](./0007-layered-exceptions-and-result.md)'s single-unwind-primitive
   model). `throw expr` desugars to exactly this send
   ([TDR-0027](./0027-error-handling-surface-syntax.md) §1). Installed on
...
- Unblocks the later error-reification unit (re-pointing native
  ...
  [TDR-0027](./0027-error-handling-surface-syntax.md)): both now have a real
