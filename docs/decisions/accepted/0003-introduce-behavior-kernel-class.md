# TDR-0003 — Introduce `Behavior` as a shared kernel class

- Legacy record: `ADR-0003`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: [TDR-0002](./0002-metaclass-tower-parallel-rule.md); `docs/object-model.md`
...
([TDR-0002](./0002-metaclass-tower-parallel-rule.md)) express cleanly rather than
