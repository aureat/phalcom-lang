# TDR-0054 — Class declarations join the binding namespace; the duplicate diagnostic carries both spans

- Legacy record: `PDR-0002`
- Ratified: 2026-07-19

- Status: Accepted
- Date: 2026-07-19
- Amends: [TDR-0053](./0053-classes-are-closed.md) — narrows ruling 8 (its import half is
...
- Related: `../forge/units/U-BINDINGS/u30-bindings-spec.md` (L-3/L-5, §12C),
  [TDR-0052](./0052-let-const-bindings-and-field-mutability.md),
