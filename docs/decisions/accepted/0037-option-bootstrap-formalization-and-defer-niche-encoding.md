# TDR-0037 — `Option` bootstrap formalization; defer niche-encoding

- Legacy record: `ADR-0044`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Related: [TDR-0006](./0006-option-as-abstract-with-some-none.md) (abstract
  `Option` + `Some`/`None`), [TDR-0009](./0009-tagged-value-enum.md) (tagged
  `Value` enum — the representation a niche would change), [TDR-0008](./0008-handle-arena-heap.md)
