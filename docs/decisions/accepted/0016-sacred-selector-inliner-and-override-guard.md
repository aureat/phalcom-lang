# TDR-0016 — Sacred-selector inliner with override-epoch deopt guard

- Legacy record: `ADR-0018`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/control-flow.md` §2–§3; [TDR-0004](./0004-boolean-as-abstract-bool-with-true-false.md); [TDR-0005](./0005-function-as-abstract-callable-root.md); [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md); [TDR-0012](./0012-closure-upvalues-and-frame-token-return.md)
...
- Non-local `return` inside an inlined block body unwinds to the home method frame
  exactly as a non-inlined block would ([TDR-0012](./0012-closure-upvalues-and-frame-token-return.md)):
...
1. **Selector spelling `ifTrue(_:ifFalse:)` vs spec's `ifTrue(_)ifFalse(_)`.**
   ...
   ([TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)) naturally produce.
...
- **No guard (trust the kernel).** Inline unconditionally and forbid overriding sacred
  ...
  method" ([TDR-0004](./0004-boolean-as-abstract-bool-with-true-false.md),
  [TDR-0005](./0005-function-as-abstract-callable-root.md)) and would make Bool/Block
  second-class.
