# TDR-0062 — Errors carry structure and cheap origin: one cause chain, a `kind` symbol, incremental capture

- Legacy record: `PDR-0010`
- Ratified: 2026-07-20
...
- Date: 2026-07-20
- Related: [TDR-0007](./0007-layered-exceptions-and-result.md) (layered exceptions +
  `Result`), [TDR-0032](./0032-amend-floor-admit-block-on-ensure.md)
  (`Block#on`/`Block#ensure` — the unwind path this record instruments),
  [TDR-0047](./0047-non-moving-mark-sweep-collector.md) §7 (why an off-heap `Value`
  is a UAF), [TDR-0057](./0057-resources-are-disposable-handles-not-finalized.md) §4 (use-after-close
  raises — a `kind` consumer), [TDR-0059](./0059-bounded-call-depth-and-native-reentrancy.md) §2
...
new classes is deferred by `U-ERR/plan.md:277-281` — and [TDR-0053](./0053-classes-are-closed.md)
plus [TDR-0035](./0035-hierarchy-stability-policy.md) make minting kernel classes
...
[TDR-0057](./0057-resources-are-disposable-handles-not-finalized.md) §3b makes `close` return
