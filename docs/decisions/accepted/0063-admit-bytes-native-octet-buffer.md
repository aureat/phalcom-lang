# TDR-0063 — Admit `Bytes`: a native octet buffer arm, ten floor primitives, and the container bulk-op posture

- Legacy record: `PDR-0011`
- Ratified: 2026-07-20

- Status: **Accepted** (ratified 2026-07-20, same day as proposed)
- Date: 2026-07-20
- Related: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (the floor
  freeze **this record amends** — `docs/decisions/` is frozen, so the amendment is carried here, the
  way ADR-0039/ADR-0049 carried theirs when that folder was live),
  [TDR-0018](./0018-kernel-list-native-array-protocol.md) (the governing
  precedent: native storage arm, `.ph` protocol above),
  [TDR-0041](./0041-amend-iteration-bare-cursor-sentinel-and-iterable-root.md)
  (`Iterable` root, bare-cursor iteration),
  [TDR-0050](./0050-amend-floor-admit-string-byte-and-raw-write-primitives.md)
  (String byte floor — the asymmetry in ruling 3 below),
  [TDR-0047](./0047-non-moving-mark-sweep-collector.md) (non-moving GC —
  **made security-relevant by ruling 7**),
  [TDR-0022](./0022-numeric-surface-split-int-float-and-division.md)
  (Accepted, **verified unbuilt 2026-07-20** — bears on ruling 2),
  [TDR-0057](./0057-resources-are-disposable-handles-not-finalized.md) §7a /
  [`stream-protocol.md`](../../spec/current/stdlib/stream-protocol.md) §9 (the consumer that makes
  this a blocker: every stream selector takes or fills a `Bytes`)
- Spec: [`docs/spec/current/stdlib/bytes.md`](../../spec/current/stdlib/bytes.md) holds the protocol,
  laws, and conformance harness. Exploration and precedent survey:
  [`docs/spec/current/drafts/bytes.md`](../spec/current/drafts/bytes.md).
...
[TDR-0064](./0064-numeric-tower-implementation-and-floor-amendment.md) (numeric tower, Proposed
