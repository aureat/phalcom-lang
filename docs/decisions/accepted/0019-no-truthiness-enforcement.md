# TDR-0019 — No-truthiness enforcement: typed branch floor + literal-only compile check

- Legacy record: `ADR-0021`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/values-and-absence.md` §3.5;
  [TDR-0006](./0006-option-as-abstract-with-some-none.md);
  [TDR-0004](./0004-boolean-as-abstract-bool-with-true-false.md);
  [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md);
  `phalcom-core/src/compiler/lib.rs` (`is_option_literal`, `branch_condition_of`),
  `phalcom-core/src/compiler/inliner.rs`

## Context

[TDR-0006](./0006-option-as-abstract-with-some-none.md) settled that absence is
...
[TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md) (U5) is the other
...
1. **Runtime no-coercion floor (general).** `Option`, `Some`, and `None` **never
   ...
   ([TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)), which
...
- **Implicit truthiness** (coerce `Option`/`Some`/`None` to `Bool`). Familiar
  ...
  [TDR-0006](./0006-option-as-abstract-with-some-none.md): it reintroduces exactly
