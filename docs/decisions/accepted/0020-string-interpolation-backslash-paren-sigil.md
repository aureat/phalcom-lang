# TDR-0020 — String interpolation uses the `\(expr)` sigil

- Legacy record: `ADR-0022`
- Ratified: 2026-07-12
...
- Related: `docs/spec/current/lexical-structure.md` §5 (string interpolation);
  ...
  [TDR-0014](./0014-hand-written-lexer-and-recursive-descent-parser.md)
...
([TDR-0014](./0014-hand-written-lexer-and-recursive-descent-parser.md)'s
...
`"\(…)"` for exactly the objects [TDR-0013](./0013-object-default-tostring.md) governs:
