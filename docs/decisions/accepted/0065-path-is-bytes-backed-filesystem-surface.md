# TDR-0065 — `Path` is bytes-backed, not a `String`; the filesystem surface

- Legacy record: `PDR-0013`
- Ratified: 2026-07-20

- Status: **Accepted** (ratified 2026-07-20, same day as proposed)
- Date: 2026-07-20
- Related: [TDR-0057](./0057-resources-are-disposable-handles-not-finalized.md) §7 (the `File`
  selector surface, **already ratified there** — this record adds the types around it, it does
  not reopen them), [TDR-0056](./0056-io-is-future-shaped-reactor-owned.md) §1/§3 (every
  blocking selector returns `Future`; the filesystem half runs on the worker pool),
  [TDR-0063](./0063-admit-bytes-native-octet-buffer.md) (`Bytes`, the backing store — this
  record **composes with it** and depends on its ratification),
  [TDR-0064](./0064-numeric-tower-implementation-and-floor-amendment.md) ruling 21's
  rebase discipline (three Proposed floor amendments now share the 137 base; whichever
  ratifies later rebases),
  [TDR-0036](./0036-no-default-arguments-keep-selector-identity-pristine.md)
