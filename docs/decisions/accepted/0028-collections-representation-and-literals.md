# TDR-0028 — Collections: native representation, shared protocol, and literal surface

- Legacy record: `ADR-0032`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Related: [TDR-0018](./0018-kernel-list-native-array-protocol.md) (native `List`);
  [TDR — List literals `[a, b, c]` desugar to `List` construction sends](./0025-list-literal-syntax.md) (list literal — **ratified to Accepted here**);
  [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md) (`hash`);
  [TDR-0019](./0019-no-truthiness-enforcement.md) (no truthiness);
  [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (floor);
  [TDR-0014](./0014-hand-written-lexer-and-recursive-descent-parser.md) (lexer/parser);
...
**Proposal**) and an in-flight list-literal ADR ([TDR — List literals `[a, b, c]` desugar to `List` construction sends](./0025-list-literal-syntax.md),
...
([TDR-0008](./0008-handle-arena-heap.md)), mirroring `List`'s `ListObject`
([TDR-0018](./0018-kernel-list-native-array-protocol.md)):
...
[TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) amendment** for its raw
...
- **Key rule.** A bare identifier before `:` is a **symbol** key (`{a: 1}` ⇒ key
  ...
  ([TDR-0023](./0023-external-internal-parameter-names.md)). A **string/number literal
...
- **Owners.** List/Map/Tuple literals: **U-LEX** (surface) over the class arms;
  ...
  ([TDR-0018](./0018-kernel-list-native-array-protocol.md)), each conforming to the
  protocol harness.
