# TDR-0060 — Every failed cell reports, and reporting happens before unwinding

- Legacy record: `PDR-0008`
- Ratified: 2026-07-20
...
- Related: [U-REPL impl/02-session-and-cells.md §51-52](../forge/units/U-REPL/impl/02-session-and-cells.md)
  ...
  fail the cell), [TDR-0012](./0012-closure-upvalues-and-frame-token-return.md)
  (open→closed upvalues — why cell unwinding closes them first),
  [TDR-0059](./0059-bounded-call-depth-and-native-reentrancy.md) (the recursion case `catch_unwind`
  cannot catch)
...
[TDR-0059](./0059-bounded-call-depth-and-native-reentrancy.md) §1's native re-entrancy counter,
not a panic guard.
