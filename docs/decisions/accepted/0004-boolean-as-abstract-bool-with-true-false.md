# TDR-0004 — Represent booleans as abstract `Bool` + `True`/`False`

- Legacy record: `ADR-0004`
- Ratified: 2026-07-11
...
minimum correctness fix — so it can follow the [TDR-0002](./0002-metaclass-tower-parallel-rule.md)
/ [TDR-0003](./0003-introduce-behavior-kernel-class.md) kernel work.
