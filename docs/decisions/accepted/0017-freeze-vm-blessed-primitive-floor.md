# TDR-0017 — Freeze the VM-blessed primitive floor

- Legacy record: `ADR-0019`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Amended by: [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md)
...
- Related: [TDR-0004](./0004-boolean-as-abstract-bool-with-true-false.md); [TDR — Keep a single flat `Number` type backed by `f64`](../retired/number-as-flat-f64.md); [TDR-0005](./0005-function-as-abstract-callable-root.md); [TDR-0006](./0006-option-as-abstract-with-some-none.md); [TDR-0008](./0008-handle-arena-heap.md); [TDR-0009](./0009-tagged-value-enum.md); `docs/spec/current/experimental/bootstrapping-and-self-hosting.md` (D1)
...
4. **`Number` arithmetic** — the native numeric operations: exact `Int`
   (`checked_*` + bignum boxing) and `Float` (`f64`) ops ([TDR-0022](./0022-numeric-surface-split-int-float-and-division.md),
...
- It does **not** freeze representation choices that live *below* the floor behind
  ...
  ([TDR-0022](./0022-numeric-surface-split-int-float-and-division.md)) and NaN-boxing
