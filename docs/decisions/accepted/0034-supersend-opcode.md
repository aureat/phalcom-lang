# TDR-0034 — Add the `SuperSend` dispatch opcode for `super.sel(…)`

- Legacy record: `ADR-0040`
- Ratified: 2026-07-12
...
- Related: [ADR-0012](0012-label-encoded-selectors.md) (label-encoded selectors
  ...
  `Invoke`, keying on the same selector encoding); [TDR-0002](./0002-metaclass-tower-parallel-rule.md)
  ...
  slots in place without aliasing); [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)
  (override-epoch guard — the IC-invalidation seam a future cached `SuperSend`
  must share); `../../forge/units/U-INH/u27-inh.md` (DEC-INH-B/D/F — the decisions
...
- **Walk**: start at `defining.superclass` on the instance side. For a
  ...
  ([TDR-0002](./0002-metaclass-tower-parallel-rule.md) parallel rule). `NewInstance`
...
census is unchanged ([TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) is not
...
- **Inline caching (DEC-INH-F):** `SuperSend` has a static per-call-site start
  ...
  [TDR — Methods are open; superclass reparenting is sealed](../retired/class-hierarchy-mutability.md)/[TDR-0035](./0035-hierarchy-stability-policy.md)
  ...
  `SuperSend` still shares [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)'s
