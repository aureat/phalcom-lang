# TDR-0018 — Kernel `List` is a native-array-backed Phalcom protocol on the critical path

- Legacy record: `ADR-0020`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Resolves: DEC-A (kernel `List` — unscheduled hard dependency)
- Related: [TDR-0006](./0006-option-as-abstract-with-some-none.md); [TDR-0008](./0008-handle-arena-heap.md); [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md); [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md); `docs/spec/current/messages.md` §4 (variadics); `docs/spec/current/experimental/bootstrapping-and-self-hosting.md` (D2); `docs/forge/PHASE2-INDEX.md` (DEC-A)
