# TDR-0022 — Split `Number` into exact `Int` (auto-promoting bignum) and `Float`; `/` is true division, `~/` is integer division

- Legacy record: `ADR-0024`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Supersedes (in part): [TDR — Keep a single flat `Number` type backed by `f64`](../retired/number-as-flat-f64.md) — its single-`f64`
  representation now applies only to `Float`; `Int` gets its own exact representation.
- Related: [TDR-0008](./0008-handle-arena-heap.md) (heap home for `LargeInt`),
  [TDR-0009](./0009-tagged-value-enum.md) (`Value` gains `Int`/`Float` variants),
  [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md) (value-based `Number#hash`),
  [TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md) (arithmetic inliner + deopt),
  [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md) (selector dispatch),
  `docs/spec/current/open-questions.md` Q2, `docs/spec/current/core/forward-compat.md` §4,
  `phalcom-core/src/value.rs`, `primitive/number.rs`

## Context

[TDR — Keep a single flat `Number` type backed by `f64`](../retired/number-as-flat-f64.md) modeled every number as one unboxed `f64`
...
([TDR-0016](./0016-sacred-selector-inliner-and-override-guard.md)) hardens**, because
...
- **`hash` canonicalizes** (Python-style): an integral `Float` hashes as the equal
  ...
  [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md) / forward-compat §4
