# TDR-0046 — Reactive tracking-context and effect scheduler need a native module, not class-side `.ph` state

- Legacy record: `ADR-0058`
- Ratified: 2026-07-13
...
- Related: [`docs/spec/current/concurrency.md`](../../spec/current/concurrency.md) §2
  ...
  (the `Reactive` runtime this unblocks, R-2), [TDR-0044](./0044-two-speed-ratification-annotation-decorator-tiers.md)
