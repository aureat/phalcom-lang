# TDR-0057 — Native resources are closeable handles with a generation-tagged table; no finalizers

- Legacy record: `PDR-0005`
- Ratified: 2026-07-20
...
- Related: [TDR-0047](./0047-non-moving-mark-sweep-collector.md) (§Context banks
  "no finalizers exist" as a reason the collector is hazard-free — **this decision keeps that
  true**), [TDR-0012](./0012-closure-upvalues-and-frame-token-return.md)
  (frame tokens — the generation-tag precedent),
  [TDR-0007](./0007-layered-exceptions-and-result.md) §4 (unified unwind — what
  makes `ensure`-scoping sound), [TDR-0056](./0056-io-is-future-shaped-reactor-owned.md)
  (the resources this governs), [ffi.md](../spec/current/drafts/ffi.md) §8 **F-3** (this closes it),
...
classic reason a language grows finalizers anyway, and [ffi.md](../spec/current/drafts/ffi.md) F-3
...
sends `read(_)`. This follows the [TDR-0041](./0041-amend-iteration-bare-cursor-sentinel-and-iterable-root.md)
...
**This does not carve an exception into [TDR-0056](./0056-io-is-future-shaped-reactor-owned.md)
...
3. **`close -> Result` flushing synchronously** — unavailable. [TDR-0055](./0055-no-user-visible-threads-fibers-and-isolates.md)
...
- `finish` is what documentation should teach; two selectors rather than one because
  [TDR-0036](./0036-no-default-arguments-keep-selector-identity-pristine.md) forbids
...
[`stream-protocol.md`](../../spec/current/stdlib/stream-protocol.md).

Selector spellings follow [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)
(comma form; `openWith(_, mode:)` is one selector with a labelled second parameter) and
[TDR-0036](./0036-no-default-arguments-keep-selector-identity-pristine.md) (no default
...
- The resource table must be drained on VM shutdown, and on isolate teardown if
  [TDR-0055](./0055-no-user-visible-threads-fibers-and-isolates.md) §2 is ever built.
