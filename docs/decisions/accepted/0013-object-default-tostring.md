# TDR-0013 — `Object` default `toString` is `"<ClassName>"`

- Legacy record: `ADR-0015`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/object-model.md` §2, §8; `docs/spec/current/classes.md`; forge finding F4; [TDR-0008](./0008-handle-arena-heap.md)
