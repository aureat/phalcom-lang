# TDR-0006 — Represent absence as abstract `Option` + `Some`/`None`

- Legacy record: `ADR-0007`
- Ratified: 2026-07-11

- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/values-and-absence.md` §3; [TDR-0004](./0004-boolean-as-abstract-bool-with-true-false.md); `phalcom-core/src/nil.rs`, `value.rs`
