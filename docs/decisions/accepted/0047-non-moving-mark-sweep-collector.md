# TDR-0047 — Reclamation is a non-moving precise mark-sweep collector

- Legacy record: `ADR-0050`
- Ratified: 2026-07-14
...
- Date: 2026-07-13
- Related: [TDR-0008](./0008-handle-arena-heap.md) (handle/arena heap — this ADR
  lands the collector it deferred); [TDR-0009](./0009-tagged-value-enum.md)
  (`Value` repr; NaN-boxing deferral); [TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)
  (inline-cache tags key on handles); [ADR-0013](0013-block-closure-upvalues.md)
  (upvalue cells / non-local return); [TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md)
...
[TDR-0008](./0008-handle-arena-heap.md) moved the object graph into a central
...
- **Handle stability is load-bearing in three places.** Inline-cache tags key on
  `ClassId`/`ObjRef` ([TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)),
...
- **Fibers carry no native stack.** A `FiberObject` owns `stack: Vec<Value>`,
  ...
  `resumer`/`result`/`entry` handles ([TDR-0026](./0026-fibers-and-futures-cooperative-concurrency.md)) —
...
- **Handles stay stable**, so inline caches ([TDR-0011](./0011-selector-signature-encoding-and-dispatch.md)),
...
- **Reference counting (`Rc`-style, with a cycle collector).** Rejected. The
  ...
  reason [TDR-0008](./0008-handle-arena-heap.md) dropped `Rc`); a bolt-on cycle
  ...
  moves freely, no clone/refcount" invariant of [TDR-0009](./0009-tagged-value-enum.md).
