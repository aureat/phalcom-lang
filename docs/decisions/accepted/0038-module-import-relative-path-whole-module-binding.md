# TDR-0038 — `import` resolves by relative file path and binds a whole `Module`; amend the frozen floor +1 (`Module#doesNotUnderstand`)

- Legacy record: `ADR-0045`
- Ratified: 2026-07-12

- Status: Accepted
- Date: 2026-07-12
- Supersedes (partially): [TDR — A module is a file; exports are public by default; imports are qualified, selective, or aliased](../retired/modules-as-files-with-public-by-default-imports.md)
  ...
  are **kept unchanged**.
- Amends: [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) (the frozen floor);
  amendment precedent: [TDR-0021](./0021-amend-floor-admit-hash-and-kernel-reflection.md),
  [TDR-0031](./0031-amend-floor-admit-error-root.md),
  [TDR-0032](./0032-amend-floor-admit-block-on-ensure.md),
  [TDR-0033](./0033-amend-floor-admit-collection-container-primitives.md)
...
open-question **Q8**. [TDR — A module is a file; exports are public by default; imports are qualified, selective, or aliased](../retired/modules-as-files-with-public-by-default-imports.md)
...
[TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) §1's **derivability test**: a
...
2. **Binding: whole-module only (ADR-0027's "aliased" form; qualified/selective
   ...
   (`let`-shaped, [TDR — Variable bindings are `let` (immutable) and `var` (mutable)](../retired/let-and-var-bindings.md)) — never a namespace merge
...
**Amend [TDR-0017](./0017-freeze-vm-blessed-primitive-floor.md) to admit exactly one
...
- **Path canonicalization is the correctness-critical step.** Skipping it (or probing
  ...
  precise failure mode [TDR-0008](./0008-handle-arena-heap.md)'s handle-identity
