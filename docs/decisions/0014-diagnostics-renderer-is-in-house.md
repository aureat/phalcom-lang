...
- Status: Accepted
- Date: 2026-07-20
- Related: [`docs/spec/traceback/implementation-spec.md`](../spec/traceback/implementation-spec.md)
  §1 (the full grounds and the architecture this record commits to),
  [`docs/spec/traceback/color.md`](../spec/traceback/color.md) (the palette discipline that
...
traceback specification (`docs/spec/traceback/`) fixes hard rendering commitments: 13 semantic
