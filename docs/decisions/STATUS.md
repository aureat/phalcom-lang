...
| [0011](0011-admit-bytes-native-octet-buffer.md) | Admit `Bytes`: native octet buffer arm, ten floor primitives, and the container bulk-op admission posture (amends ADR-0019, floor 137 → 147) | Accepted (ratified 2026-07-20) | *amends* ADR-0019 | | ❌ ratified 2026-07-20 — U-BYTES dispatched against [`impl/bytes.md`](../spec/v0.2/impl/bytes.md); spec [`bytes.md`](../spec/v0.2/core/bytes.md) now normative; discharges [`stream-protocol.md`](../spec/v0.2/core/stream-protocol.md) §9's hard dependency |
...
| [0013](0013-path-is-bytes-backed-filesystem-surface.md) | `Path` is bytes-backed, not a `String`; the filesystem surface (`Fs`/`DirEntry`/`Metadata`/`OpenMode`; +1 `Bytes#utf8Lossy_`) | Accepted (ratified 2026-07-20) | | | ❌ ratified 2026-07-20 — [`filesystem.md`](../spec/v0.2/core/filesystem.md) now fully normative. Impl still blocked on the reactor (0004 §2), **except** `Bytes#utf8Lossy_` (ruling 4), which has no reactor dependency and ships with U-BYTES |
