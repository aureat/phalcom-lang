# TDR — Attribute-class resolution is suffix-first: `@Name` resolves `NameAttribute`, then `Name`

- Legacy record: `PDR-0022`
- Proposed: 2026-07-20

- Status: Proposed
- Date: 2026-07-20
- Related: [TDR — Decorator naming: lowercase names are compiler builtins, Capitalized names are `Attribute` classes](./decorator-naming-convention.md) (the convention
...
1. **`@Name` resolution order**: try `NameAttribute` first, then `Name`.
   ...
   [TDR — Decorator naming: lowercase names are compiler builtins, Capitalized names are `Attribute` classes](./decorator-naming-convention.md) ruling 6).
