# TDR — `Future#cancel` is renunciation: settle `#cancelled` now, suppress unstarted work best-effort, interrupt nothing

- Legacy record: `PDR-0017`
- Proposed: 2026-07-20

- Status: Proposed
- Date: 2026-07-20
- Related: [`reactor.md`](../../spec/current/stdlib/reactor.md) §7/§11 **Q-R4** (the deferred
  unit this discharges; its §7.1-.3 obligations are the fixed substrate),
  [TDR-0056](../accepted/0056-io-is-future-shaped-reactor-owned.md) (Consequences: "Cancellation is
  now unavoidable … a leaked registration is an fd leak"),
  [TDR-0057](../accepted/0057-resources-are-disposable-handles-not-finalized.md) §5 (leak reporting —
  the composition this record must not break),
  [TDR — The network surface: TCP is poller-backed and `Future`-shaped, DNS rides the pool, endpoints are address-plus-port](./network-surface-tcp-dns-endpoints.md) (its Q-N5 timeout/Happy-Eyeballs
...
([`stdlib/cancellation.md`](../../spec/current/stdlib/cancellation.md) Q-C1/Q-C2), not implied.
