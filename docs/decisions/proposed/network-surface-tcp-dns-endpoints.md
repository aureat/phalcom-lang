# TDR — The network surface: TCP is poller-backed and `Future`-shaped, DNS rides the pool, endpoints are address-plus-port

- Legacy record: `PDR-0015`
- Proposed: 2026-07-20

- Status: Proposed
- Date: 2026-07-20
- Related: [TDR-0056](../accepted/0056-io-is-future-shaped-reactor-owned.md) (IO is `Future`-shaped;
  reactor before surface — every ruling here presupposes it),
  [TDR-0057](../accepted/0057-resources-are-disposable-handles-not-finalized.md) §3/§4/§7
  ...
  *already ratified there* — this record cites both and redesigns neither),
  [TDR-0065](../accepted/0065-path-is-bytes-backed-filesystem-surface.md) rulings 1/2/5 (the
...
[`stdlib/net.md`](../../spec/current/stdlib/net.md).
...
`docs/spec/current/traceback/implementation-spec.md` §8.1, filed with that plan's lane rather
...
Floor delta is nonzero and **enumerated in [`impl/net.md`](../forge/units/U-NET/implementation-spec.md)**,
...
- The socket-echo conformance row (reactor.md §10) finally has the surface it was written
  against; it moves into [`stdlib/net.md`](../../spec/current/stdlib/net.md) §10's harness.
