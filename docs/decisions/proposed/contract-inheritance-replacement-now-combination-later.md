# TDR — Contract inheritance: lexical replacement now (documented, Liskov-unsound), runtime combination later behind the metadata gate

- Legacy record: `PDR-0023`
- Proposed: 2026-07-20

- Status: Proposed
- Date: 2026-07-20
- Related: [`contracts.md`](../design/decorators/canonical/contracts.md) (flagged the gap),
  [`requires.md`](../../spec/current/decorators/requires.md) /
  [`ensures.md`](../../spec/current/decorators/ensures.md) /
  [`invariant.md`](../../spec/current/decorators/invariant.md) (as-built weaves),
  DEF-11 (contract metadata never emitted — the gate),
  [TDR — The metaobject gate: `Method.fromBlock`, `Method#invokeOn`, `Behavior#defineMethod` (floor amendment; amends ADR-0019)](./metaobject-gate-floor-amendment.md) (the runtime-check
  route's other prerequisite),
  [TDR-0042](../accepted/0042-invariant-reentrancy-scope-and-layout-confined-decorator-state.md).
...
3. **The combination design is named now, built later.** When DEF-11's
   ...
   [TDR — The metaobject gate: `Method.fromBlock`, `Method#invokeOn`, `Behavior#defineMethod` (floor amendment; amends ADR-0019)](./metaobject-gate-floor-amendment.md)'s reflective surface
