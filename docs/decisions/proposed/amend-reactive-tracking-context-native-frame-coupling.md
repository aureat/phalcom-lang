# TDR — Amend ADR-0058 + ADR-0033: the reactive tracking context is bound to the native-frame switch guard

- Legacy record: `ADR-0059`
- Proposed: 2026-07-14

- Status: Proposed (needs user ratification)
- Date: 2026-07-14
- Amends: [TDR-0046](../accepted/0046-reactive-tracking-context-needs-a-native-module.md)
  (adds a soundness invariant its Consequences understate);
  [TDR — Amend the fiber execution model — trampoline the bytecode block call-site](../retired/amend-fiber-execution-trampolined-block-callsite.md)
  (adds `Reactive.current` to §Decision 4's sequencing constraint)
- Related: [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §4–§5
...
[TDR-0046](../accepted/0046-reactive-tracking-context-needs-a-native-module.md) makes
...
1. **`trackedBy` is moved onto the trampolined path.** [TDR — Amend the fiber execution model — trampoline the bytecode block call-site](../retired/amend-fiber-execution-trampolined-block-callsite.md)
...
re-entrant native path ([TDR — Amend the fiber execution model — trampoline the bytecode block call-site](../retired/amend-fiber-execution-trampolined-block-callsite.md)
...
([TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §Alternatives)
