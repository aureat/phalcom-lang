# TDR — Decorator naming: lowercase names are compiler builtins, Capitalized names are `Attribute` classes

- Legacy record: `PDR-0021`
- Proposed: 2026-07-20

- Status: Proposed
- Date: 2026-07-20
- Related: [`docs/design/decorators/canonical/README.md`](../design/decorators/canonical/README.md)
  (naming section this ratifies; collision registry COLL-1…5),
  [`mechanism.md`](../design/decorators/canonical/mechanism.md) (the two resolution paths),
  [TDR-0067](../accepted/0067-decorator-carry-forward-and-v03-runtime-mandate.md) §5
  (left this open), [TDR — Attribute-class resolution is suffix-first: `@Name` resolves `NameAttribute`, then `Name`](./attribute-suffix-resolution.md) (the
  companion lookup rule this convention makes necessary),
  [TDR-0045](../accepted/0045-decorator-granularity-vs-proxy-granularity-split.md)
...
2. **Capitalized `@Name` = an `Attribute` subclass** (stdlib or user), for
   ...
   class chain-walk (per [TDR — Attribute-class resolution is suffix-first: `@Name` resolves `NameAttribute`, then `Name`](./attribute-suffix-resolution.md)'s
...
5. **The framework renames in
   [`frameworks.md`](../design/decorators/canonical/frameworks.md) are ratified with this
