# TDR — Process and environment: argument-vector spawning, a read-only environment, and `System` stays the one effect namespace

- Legacy record: `PDR-0019`
- Proposed: 2026-07-20
...
- Related: [`system.md`](../../spec/current/system.md) §2 (the specified-but-unbuilt
  ...
  [TDR-0056](../accepted/0056-io-is-future-shaped-reactor-owned.md) §1/§3 (Future shape; worker
  pool), [TDR-0057](../accepted/0057-resources-are-disposable-handles-not-finalized.md) §3-§5
  (`Child < Resource`; leak reporting),
  [TDR-0065](../accepted/0065-path-is-bytes-backed-filesystem-surface.md) ruling 4 (the
  lossy-display / exact-bytes split, reused for env and args),
  [TDR — The network surface: TCP is poller-backed and `Future`-shaped, DNS rides the pool, endpoints are address-plus-port](./network-surface-tcp-dns-endpoints.md) ruling 4 (the two-selectors-
