# TDR — Amend the fiber execution model — trampoline the bytecode block call-site

- Legacy record: `ADR-0033`
- Retired: 2026-07-12

- Status: Deferred (past v0.2 — the callback-generator ergonomic is delivered for
  v0.2 by [TDR-0029](../accepted/0029-iteration-protocol-cursor.md)'s `for`/cursor loop, which
  lowers to an inlined `while` and suspends freely under
  [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §4. Revisit this
  ...
  with the [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §5
  fiber-switch signal per §Decision 4 below)
- Date: 2026-07-12
- Related: [TDR-0029](../accepted/0029-iteration-protocol-cursor.md) (the v0.2 resolution — `for`/cursor);
  [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
  (fiber execution model — **§4 amended here**); [TDR-0012](../accepted/0012-closure-upvalues-and-frame-token-return.md)
  (block closures + frame-token non-local return); [TDR-0007](../accepted/0007-layered-exceptions-and-result.md)
  (one unwind primitive / error floor); [TDR-0016](../accepted/0016-sacred-selector-inliner-and-override-guard.md)
  (sacred-selector inliner); [TDR-0017](../accepted/0017-freeze-vm-blessed-primitive-floor.md)
  (frozen floor); [`docs/spec/current/concurrency.md`](../../spec/current/concurrency.md) §1

## Context

[TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §4 fixed the
...
1. **`List.each` is already pure Phalcom** — an *inlined* `while` over
   ...
   The `while` is lowered to `Jump`/`Loop` by the [TDR-0016](../accepted/0016-sacred-selector-inliner-and-override-guard.md)
...
owns, freely pushed/popped/parked, and — per [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
...
**Amend [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §4: block
...
`home_frame_token` stamp for non-local return ([TDR-0012](../accepted/0012-closure-upvalues-and-frame-token-return.md);
...
the [TDR-0016](../accepted/0016-sacred-selector-inliner-and-override-guard.md) sacred-selector
...
**ordinary** handlers ([TDR-0012](../accepted/0012-closure-upvalues-and-frame-token-return.md)
token search; [TDR-0007](../accepted/0007-layered-exceptions-and-result.md) error floor,
...
same "typed signal, not a length delta" discipline [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
...
fiber's lifetime. [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
...
- **The callback generator works, verbatim.** `Fiber.new { list.each { x =>
  ...
  [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §4 index-iteration
...
- **The real cost is owned unwind bookkeeping.** The recursive `run_until`
  ...
  surface — it touches the [TDR-0012](../accepted/0012-closure-upvalues-and-frame-token-return.md)
  frame-token return and [TDR-0007](../accepted/0007-layered-exceptions-and-result.md) error
...
- **Residue (retained Option A tail).** Not yield-transparent: reflective/dynamic
  ...
  those paths — a strictly smaller set than under [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
...
- **No new floor surface, no GC commitment.** `CallBlock` is a dispatch-shape
  ...
  [TDR-0017](../accepted/0017-freeze-vm-blessed-primitive-floor.md) floor. Block activations
  remain VM `CallFrame`s inside the arena `FiberObject`
  ([TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md) §2/§7); no native
  fiber stacks are introduced, so [TDR-0008](../accepted/0008-handle-arena-heap.md)'s
...
- **Full Option B now** (de-recurse `block_call`, `perform`, dNU forward, and every
  ...
  large invasive rewrite [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
  §Alternatives deferred. This amendment is the minimal high-leverage subset;
  Option B remains additively reachable from here.
- **`for`/cursor iteration ([TDR-0029](../accepted/0029-iteration-protocol-cursor.md)) — the
  ...
  yield suspends freely under [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
  ...
  ([TDR-0029](../accepted/0029-iteration-protocol-cursor.md) §4/§6 deliberately keep iteration
...
- **Do nothing (keep restricted Option A).** The [TDR-0026](../accepted/0026-fibers-and-futures-cooperative-concurrency.md)
