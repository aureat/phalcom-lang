# TDR — Methods are open; superclass reparenting is sealed

- Legacy record: `ADR-0026`
- Retired: 2026-07-12

- Status: Retired (superseded by PDR-0001, 2026-07-19)
- Date: 2026-07-12
- Related: [TDR-0010](../accepted/0010-static-instance-slot-layout.md) (static per-class slot layout),
  [TDR-0015](../accepted/0015-class-side-stored-static-fields.md) (class-side field offsets up the tower),
  [TDR-0016](../accepted/0016-sacred-selector-inliner-and-override-guard.md) (override-epoch deopt guard),
  [TDR-0008](../accepted/0008-handle-arena-heap.md) (handle heap — makes a future reshape implementable),
...
- [TDR-0016](../accepted/0016-sacred-selector-inliner-and-override-guard.md) already ships an
...
- [TDR-0010](../accepted/0010-static-instance-slot-layout.md) /
  [TDR-0015](../accepted/0015-class-side-stored-static-fields.md) compute field offsets from the
...
- **Door left open (explicitly non-foreclosed).** Reparenting is sealed *by policy*,
  not by impossibility — [TDR-0008](../accepted/0008-handle-arena-heap.md)'s handle heap keeps it
