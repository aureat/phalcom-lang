# TDR — A module is a file; exports are public by default; imports are qualified, selective, or aliased

- Legacy record: `ADR-0027`
- Retired: 2026-07-12
- Consolidation review: [STATUS CONFLICT] legacy file was stored under `retired/` while its body said Accepted; legacy placement controls this consolidation.

- Status: Accepted
- Date: 2026-07-12
- Related: `docs/forge/units/U-CORE-0/decision-register.md` Q4 (core = "the core module's exports,
  auto-imported"), `docs/spec/current/core/forward-compat.md` §3, `docs/spec/current/open-questions.md` Q8,
  `vm.rs::install_core`, `phalcom-core/core/core.ph`

## Context

The `import` token exists in the lexer but has no semantics. One boundary is
**already ruled** ([decisions.md Q4](../forge/units/U-CORE-0/decision-register.md)): kernel names live in
