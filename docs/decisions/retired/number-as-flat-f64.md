# TDR — Keep a single flat `Number` type backed by `f64`

- Legacy record: `ADR-0005`
- Retired: 2026-07-11

- Status: Superseded in part by [TDR-0022](../accepted/0022-numeric-surface-split-int-float-and-division.md)
- Date: 2026-07-11
- Related: `docs/object-model.md`; `phalcom-core/src/value.rs`, `primitive/number.rs`

> **Superseded in part (2026-07-12) by [TDR-0022](../accepted/0022-numeric-surface-split-int-float-and-division.md).**
