# TDR — Flat `Number` now; defer the `Integer` / `Float` split

- Legacy record: `ADR-0042`
- Retired: 2026-07-14

- Status: **Superseded by [TDR-0022](../accepted/0022-numeric-surface-split-int-float-and-division.md)** (ruled 2026-07-14)
- Date: 2026-07-12

> **Superseded (2026-07-14) by [TDR-0022](../accepted/0022-numeric-surface-split-int-float-and-division.md).**
...
- Related: [TDR-0011](../accepted/0011-selector-signature-encoding-and-dispatch.md)
  ...
  dispatch axis), [TDR-0008](../accepted/0008-handle-arena-heap.md) (handle heap — leaves a
