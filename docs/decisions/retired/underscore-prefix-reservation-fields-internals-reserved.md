# TDR — Underscore prefixes are reserved: `_` fields, `_$` language internals, `__` reserved

- Legacy record: `ADR-0061`
- Retired: 2026-07-14

- Status: Retired — superseded by PDR-0032 on 2026-08-08
- Date: 2026-07-14
- Superseded by: [TDR-0076](../accepted/0076-transition-1-language-surface-convergence.md)
- Related: [TDR-0042](../accepted/0042-invariant-reentrancy-scope-and-layout-confined-decorator-state.md) (`@construct`/`@get`/`@variant`
  derivation — this ADR makes `strip_leading_underscore` total);
  [TDR-0002](../accepted/0002-metaclass-tower-parallel-rule.md) (why `Object#__attach` is registered once,
