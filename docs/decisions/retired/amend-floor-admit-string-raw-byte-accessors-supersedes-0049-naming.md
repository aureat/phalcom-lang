# TDR — Amend floor — admit `String` raw byte accessors + `System.rawWrite(_)`

- Legacy record: `ADR-0062`
- Retired: 2026-07-15
...
> in place of the trailing-`_` convention [TDR-0050](../accepted/0050-amend-floor-admit-string-byte-and-raw-write-primitives.md)
...
**Supersedes:** [TDR-0050](../accepted/0050-amend-floor-admit-string-byte-and-raw-write-primitives.md)'s
