# TDR — Variable bindings are `let` (immutable) and `var` (mutable)

- Legacy record: `ADR-0014`
- Retired: 2026-07-11

- Status: **Superseded by [TDR-0052](../accepted/0052-let-const-bindings-and-field-mutability.md)** (2026-07-15)
...
> any method).
- Date: 2026-07-11
- Related: [open question Q1](../../spec/current/open-questions.md); `docs/spec/current/values-and-absence.md` §3; [TDR-0006](../accepted/0006-option-as-abstract-with-some-none.md)

## Context

[Open question Q1](../../spec/current/open-questions.md) left the binding forms unresolved: the
...
model ([Values & Absence](../../spec/current/values-and-absence.md), [TDR-0006](../accepted/0006-option-as-abstract-with-some-none.md))
...
- **`var x` without an initializer reads as absence: `None`** ([TDR-0006](../accepted/0006-option-as-abstract-with-some-none.md)),
  consistent with a declared-but-unassigned field ([Classes §2](../../spec/current/classes.md)).
  The private `Nil` sentinel ([TDR-0009](../accepted/0009-tagged-value-enum.md)) backs the
...
- **A surface uninitialized/`nil` value for the empty case.** Reintroduces the null
  coercion the object model exists to remove ([Values & Absence §2](../../spec/current/values-and-absence.md)).
  Rejected.
