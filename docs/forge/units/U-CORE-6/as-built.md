...
are catalogued ([object-model.md](../../../spec/v0.2/object-model.md) §4, lines 160-165) but
...
| **6.5** | Floor census (R-INV-0.1) updated in lockstep for the `message`/`raise` additions. | **C** | Bump the census audit's expected binding count **73 → 75** and add the two `(Error, selector)` rows; amend [`floor-census.md`](../../../spec/v0.2/core/floor-census.md) §2 + §1.1 in the same change. |
...
model, and [`decisions.md`](../../../spec/v0.2/core/decisions.md) §Q2 confirms it.
...
> [`floor-census.md`](../../../spec/v0.2/core/floor-census.md) §1.1/§2 and the R-INV-0.1 audit in the same
> change.
...
| `Error`/`MNU`/… catalog rows (`message`, `raise`) | [object-model.md](../../../spec/v0.2/object-model.md) §4 (lines 160-165) |
...
| Invariants R-INV-6.1…6.5 | [invariant-requirements.md](../../../spec/v0.2/core/invariant-requirements.md) §U-CORE-6 |
...
| open-Q9 resolved by ADR-0008 | [open-questions.md](../../../spec/v0.2/open-questions.md) §9 (`~~struck~~`, → ADR-0008) |
