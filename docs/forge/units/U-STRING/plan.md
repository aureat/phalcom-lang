...
| `docs/adr/0049-amend-floor-admit-string-raw-byte-accessors.md` (**new**, claim number at dispatch) | ADR-0019 amendment landing-record for the +4 (mirrors ADR-0037/ADR-0038's per-unit pattern) | ADR |
