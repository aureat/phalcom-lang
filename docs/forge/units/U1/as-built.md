...
## Invariants & tests
- **F2** (metaclass parallel-superclass deviation) preserved observationally — its fix was deferred to [U2](../U2/as-built.md).
...
## Sources
- forge: [`STATE.md`](../../archive/phase2/STATE.md) "U1 — LANDED". Per-unit planning record (`U1-plan.md`, `U1-progress.md`) folded into this spec; see git history.
