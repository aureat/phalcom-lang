# Forge implementation specs

Normative language contracts live under [`../../spec/current/`](../../spec/current/).
This index owns implementation-level plans and as-built records.

Dispatch-ready implementation plans for the surface specs in [`../../spec/current/core/`](../../spec/current/core/). One
...
[`pdr/README.md`](../../../pdr/README.md) rule 5 until that record is
...
|---|---|---|---|---|---|
| U-BYTES | [`bytes.md`](bytes.md) | [`stdlib/bytes.md`](../../spec/current/stdlib/bytes.md) | PDR-0011 + PDR-0013 r.4 | — | ✅ **shipped 2026-07-20** (`19c5db9`/`9445d1f`/`732189b` + `5ba6101`); spec is the as-built record |
| U-RESOURCE | [`resource-table.md`](resource-table.md) | [`stdlib/stream-protocol.md`](../../spec/current/stdlib/stream-protocol.md) §3 | PDR-0005 §3-§5 | — | spec ready |
| U-PATH | [`path.md`](path.md) | [`stdlib/filesystem.md`](../../spec/current/stdlib/filesystem.md) §2-§3 | PDR-0013 | U-BYTES | spec ready |
| U-STREAMS | [`streams.md`](streams.md) | [`stdlib/stream-protocol.md`](../../spec/current/stdlib/stream-protocol.md) | PDR-0005 §7a | U-BYTES, U-RESOURCE | spec ready |
| U-REACTOR | [`reactor.md`](reactor.md) | [`stdlib/reactor.md`](../../spec/current/stdlib/reactor.md) | PDR-0004, PDR-0003 §3 | — (first consumer tests need U-BYTES) | spec ready |
| U-FS | [`filesystem.md`](filesystem.md) | [`stdlib/filesystem.md`](../../spec/current/stdlib/filesystem.md) §4-§6 | PDR-0005 §7, PDR-0013 | U-PATH, U-RESOURCE, U-REACTOR, U-STREAMS | spec ready |
| U-NET | [`net.md`](net.md) | [`stdlib/net.md`](../../spec/current/stdlib/net.md) | **PDR-0015 + PDR-0016 (both Proposed — rule-5 blocked)**, PDR-0004 §3/§4, PDR-0005 §3/§4 | U-RESOURCE, U-REACTOR | spec ready, **blocked on ratification** |
| U-CANCEL | [`cancellation.md`](cancellation.md) | [`stdlib/cancellation.md`](../../spec/current/stdlib/cancellation.md) | **PDR-0017 (Proposed — rule-5 blocked)**, PDR-0004, C-FUT-3 | U-REACTOR | spec ready, **blocked on ratification**; parallel-safe with U-NET |
