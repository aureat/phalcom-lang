# U-SEQ — Implementation spec (literal `.ph` source, DEC-SEQ-A branch-conditional)

> Companion to [`plan.md`](plan.md) — read that first for rationale/rubric/hazards. This file is the
