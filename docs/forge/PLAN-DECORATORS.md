...
[attribute-classes.md](../spec/v0.2/next/attribute-classes.md),
[decorators.md](../spec/v0.2/next/decorators.md),
...
[decorators-observable.md](../spec/v0.2/next/decorators-observable.md)._
...
- **U-ANNOT-LAYOUT** (`FieldDef` / `ClassMember::Field` / `Target::Field`) — **NOT landed** (verified: absent
  ...
  plan exists (`docs/forge/units/U-ANNOT-LAYOUT/plan.md`); it depends only on U-ANNOT-CONTRACTS (landed).
