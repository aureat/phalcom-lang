...
- [x] **U-REPL** — [plan](units/U-REPL/plan.md) — **fully landed (Stages 0–6).** §D2 landed (`16b3760`); §D7 parser half landed (`2fe6aba`); §S8 landed (`380461c`); Stages 0–2 landed (`3e118ab`); Phase B (Stages 3–6 & consolidation) landed with full multi-line continuation, snapshot oracle, refine-only highlighting, completer, and `:reload` command namespace. All 6 load-bearing tests green.
