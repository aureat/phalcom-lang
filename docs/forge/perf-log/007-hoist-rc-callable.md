...
`implementation-spec.md` §4 names the obstacle exactly: **a `&Chunk` borrowed out of
...
`implementation-spec.md` §4 calls "the classic bug this unit could ship". S1b needs a
