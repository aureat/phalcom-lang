...
Status: **landed** · Unit: [U-HOTPATH](../units/U-HOTPATH/implementation-spec.md) (Tier 2) · Spec: [performance.md §4 Tier 2](../../spec/current/performance.md), [ADR-0051](../../adr/accepted/0051-performance-strategy-measure-first-tiered-optimization.md) · Behavior-invariant (no ADR, no floor change)
