...
Status: **landed** · Unit: [U-TRACE](../units/U-TRACE/plan.md) (Tier 1) · Spec: [performance.md §4 Tier 1](../../spec/v0.2/performance.md), [ADR-0051](../../adr/0051-performance-strategy-measure-first-tiered-optimization.md) · Behavior-invariant (no ADR, no floor change)
