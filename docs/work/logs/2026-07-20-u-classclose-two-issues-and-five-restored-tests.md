...
- Realizes: [TDR-0053](../../decisions/accepted/0053-classes-are-closed.md), as amended by
  [TDR-0054](../../decisions/accepted/0054-class-declarations-join-the-binding-namespace.md), per
...
shadowing it from a non-core module is not the trap [TDR-0053](../../decisions/accepted/0053-classes-are-closed.md) exists to close.
...
since its global binds the singleton value, not the class). This is TDR-0054 ruling 3's own
...
design (TDR-0054). If the *install call site itself* (`Bytecode::Method`'s handler) ever stops
