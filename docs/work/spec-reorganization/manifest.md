...
| `current/decorators/constructor.md` | M | `spec/foundations/classes.md` + `spec/extensions/decorators/constructor.md` | Canonical constructor rule, reconciled with TDR-0073. |
...
- Governing records retained: TDR-0022 and TDR-0065, TDR-0069, TDR-0071, and
  TDR-0072.
