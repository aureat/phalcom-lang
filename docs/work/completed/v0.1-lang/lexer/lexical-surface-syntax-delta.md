...
- **Realizes:** [ADR-0022](../../../adr/0022-string-interpolation-backslash-paren-sigil.md) (new — `\(expr)` sigil); spec [lexical-structure.md](../../../spec/current/lexical-structure.md) §5 (interpolation), §1 (newline suppression). Extends the U-FE hand-written lexer ([fe-front-end.md](../U-FE/fe-lexer-recursive-descent-parser.md), [ADR-0016](../../../adr/0016-hand-written-lexer-and-recursive-descent-parser.md)).
