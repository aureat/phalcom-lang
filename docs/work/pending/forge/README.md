...
**[`u0-state.md`](STATE.md)** is the live entry point, with [`INDEX.md`](forge/INDEX.md) (coordination
...
> `u0-state.md`/`DEFERRED.md` migrated to this level while the `phase-next/` copies went stale (its
> `u0-state.md` still described the U-CORE track as in-flight months after U-CORE-1..6 landed), and
...
> the current `u0-state.md`/`INDEX.md`/`DEFERRED.md` into `archive/phaseN/`, not by moving a folder.
...
- [`phase2/`](archive/phase2/) — the Phase-2 planning index, master `u0-plan.md`, `parallel-tasks.md`,
  and the closed-out `u0-state.md`/`HANDOFF.md` for that phase.
...
- Don't fork the roster: status of record is [`u0-state.md`](STATE.md) + the as-built specs +
...
- **One `u0-state.md`, one `DEFERRED.md`, at this level.** Do not create a second copy in a
...
- When a phase closes: copy `u0-state.md`/`INDEX.md`/`DEFERRED.md` into `archive/phaseN/` for
