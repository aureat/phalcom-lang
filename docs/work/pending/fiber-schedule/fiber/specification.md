...
### 7.2 `Fiber` ⊗ `Future` — the resumer/result-slot seam (with [[U-FUTURE]](../../../work/pending/fiber-schedule/future/specification.md)) {#future-seam}

*Cross-links [[U-FUTURE §The Fiber seam]](../../../work/pending/fiber-schedule/future/specification.md#the-fiber-seam);
[`concurrency.md`](../../../spec/current/concurrency.md) §2; ADR-0030 §1.*

`Future`/`async`/`await` are a **Deferred post-v0.2 track** ([[U-FUTURE]](../../../work/pending/fiber-schedule/future/specification.md)),
...
- **`Future` / `async` / `await` / scheduler / `System` hooks** — the **Deferred**
  post-v0.2 [[U-FUTURE]](../../../work/pending/fiber-schedule/future/specification.md) track. U-FIBER ships **none** of it,
