...
- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/lexical-structure.md`; `docs/spec/classes.md`;
  `docs/spec/messages-and-selectors.md`; forge fixes F9, F10;
...
- **The grammar has to grow, incrementally and with good diagnostics.** The spec
  ...
  [Messages & Selectors](../spec/messages-and-selectors.md)). Several of these
