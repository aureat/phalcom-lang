...
- Related: [ADR-0019](0019-freeze-vm-blessed-primitive-floor.md) (frozen floor,
  ...
  exceptions/`Result`); `docs/spec/core/decisions.md` Q1 (hash), §4.1 (`Method`
  superclass); `docs/spec/core/U-CORE-1-implementation-spec.md` §2.2–2.3;
  `docs/spec/core/U-CORE-3-implementation-spec.md` §2.6;
  `docs/spec/core/U-CORE-4-implementation-spec.md` §6.1;
  `docs/spec/core/U-CORE-6-implementation-spec.md` (ADR-0019 amendment section)
...
The `docs/spec/core/` U-CORE-0 requirements pass (floor census, catalog delta,
...
`docs/spec/core/README.md` cross-spec integration notes flagged this and
