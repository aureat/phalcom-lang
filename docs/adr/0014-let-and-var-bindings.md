...
- Status: Accepted
- Date: 2026-07-11
- Related: [open question Q1](../spec/open-questions.md); `docs/spec/values-and-absence.md` §3; [ADR-0007](0007-option-as-abstract-with-some-none.md)

## Context

[Open question Q1](../spec/open-questions.md) left the binding forms unresolved: the
...
model ([Values & Absence](../spec/values-and-absence.md), [ADR-0007](0007-option-as-abstract-with-some-none.md))
...
- **`var x` without an initializer reads as absence: `None`** ([ADR-0007](0007-option-as-abstract-with-some-none.md)),
  consistent with a declared-but-unassigned field ([Classes §2](../spec/classes.md)).
...
- **A surface uninitialized/`nil` value for the empty case.** Reintroduces the null
  coercion the object model exists to remove ([Values & Absence §2](../spec/values-and-absence.md)).
  Rejected.
