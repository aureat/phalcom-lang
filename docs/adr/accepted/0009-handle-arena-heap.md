...
- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/object-model.md` §6; `docs/spec/current/system.md` (gc); [open question Q4](../../spec/current/open-questions.md); forge finding F5; [ADR-0002](0002-metaclass-tower-parallel-rule.md)
