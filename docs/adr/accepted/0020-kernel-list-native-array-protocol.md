...
- Related: [ADR-0007](0007-option-as-abstract-with-some-none.md); [ADR-0009](0009-handle-arena-heap.md); [ADR-0012](0012-selector-signature-encoding-and-dispatch.md); [ADR-0019](0019-freeze-vm-blessed-primitive-floor.md); `docs/spec/current/messages.md` §4 (variadics); `docs/spec/current/experimental/bootstrapping-and-self-hosting.md` (D2); `docs/forge/PHASE2-INDEX.md` (DEC-A)
