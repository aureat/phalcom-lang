...
> any method).
- Date: 2026-07-11
- Related: [open question Q1](../../spec/current/open-questions.md); `docs/spec/current/values-and-absence.md` §3; [ADR-0007](0007-option-as-abstract-with-some-none.md)
...
model ([Values & Absence](../../spec/current/values-and-absence.md), [ADR-0007](0007-option-as-abstract-with-some-none.md))
