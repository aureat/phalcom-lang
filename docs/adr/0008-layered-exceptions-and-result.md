...
- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/error-handling.md`; `docs/spec/values-and-absence.md` §4; [ADR-0007](0007-option-as-abstract-with-some-none.md); `docs/spec/object-model.md` §Errors; `docs/spec/concurrency.md`

## Context

[Open Question §9](../spec/open-questions.md) asked whether Phalcom should use
...
- The VM **must** raise. `doesNotUnderstand`, arity mismatch, and `DeadFrameError`
  ...
  ([Object Model §Errors](../spec/object-model.md), [Blocks §5](../spec/blocks.md)).
...
- Non-local `return` is already implemented as a frame-token stack unwind
  ([Functions §3](../spec/functions.md)); fibers already `abort`/propagate/capture
  ([Fibers & Futures](../spec/concurrency.md)).
