...
- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/classes.md` §2; `docs/spec/object-model.md` §2; [ADR-0009](0009-handle-arena-heap.md); [ADR-0010](0010-tagged-value-enum.md)
...
the layout at class-definition time ([Classes §2](../spec/classes.md)). The spec
...
- **A declared-but-unassigned field reads `None`** ([Values & Absence](../spec/values-and-absence.md)).
...
- Because fields are private and non-inherited ([Classes §2](../spec/classes.md)),
...
- Slot layout is intentionally **not** inheritance-visible; cross-hierarchy field
  ...
  even under a future runtime `superclass=` ([open question Q4](../spec/open-questions.md)).
