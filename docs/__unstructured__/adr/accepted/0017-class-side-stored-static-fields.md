...
- Status: Accepted
- Date: 2026-07-11
- Related: [ADR-0011](0011-static-instance-slot-layout.md); [ADR-0002](0002-metaclass-tower-parallel-rule.md); [ADR-0007](0007-option-as-abstract-with-some-none.md); [ADR-0010](0010-tagged-value-enum.md); `docs/spec/current/classes.md` §2–3; `docs/spec/current/units/U/7-fields-and-construct.md` (DEC-D, as-built)
