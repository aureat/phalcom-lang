...
- Status: Accepted
- Date: 2026-07-11
- Related: `docs/spec/current/blocks.md` §5; `docs/spec/current/object-model.md` §4; [ADR-0006](0006-function-as-abstract-callable-root.md); [ADR-0009](0009-handle-arena-heap.md)

## Context

Blocks are the keystone construct — a block, a lambda, a method body, and a getter
body share one closure representation ([Blocks](../../spec/current/blocks.md), [ADR-0006](0006-function-as-abstract-callable-root.md)).
