...
Status: **landed** · Unit: [U-HOTPATH](../units/U-HOTPATH/implementation-spec.md) (Tier 2) · Spec: [performance.md §4 Tier 2](../../spec/current/performance.md), [TDR-0048](../decisions/accepted/0048-performance-strategy-measure-first-tiered-optimization.md) · Behavior-invariant (no ADR, no floor change)
