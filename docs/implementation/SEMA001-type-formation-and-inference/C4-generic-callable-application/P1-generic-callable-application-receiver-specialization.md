...
# SEMA001.C4.P1 — generic callable application receiver specialization
## Execution scope
...
**Related specification:** `SC-2-generic-callable-application-receiver-specialization-technical-spec.md`  
