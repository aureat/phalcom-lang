...
# TYPE001.C1.P1 — surface syntax parser ast selector family grammar
...
**Spec:** `docs/implementation/type/TYPE001-adt-gadt/C1-surface-syntax-and-family-grammar/surface-syntax-parser-ast-selector-family-grammar-spec.md`

**Baseline:** `aureat/phalcom-lang` `main` at `1892bcff51f75dd2f3df2a0661b03371250d4090`.

**Canonical plan path:** `docs/implementation/type/TYPE001-adt-gadt/C1-surface-syntax-and-family-grammar/P1-surface-syntax-parser-ast-selector-family-grammar.md`
