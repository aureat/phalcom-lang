...
---
# COLL002.C1.P1 — map runtime contract

Scope: implementation work. Requires Spec A.2 at minimum for canonical `Unit`; implementing after A.3 is preferred so Record/Tuple hash-key regressions can be tested together. This phase is otherwise independent of brace-literal grammar and is dispatchable immediately.
