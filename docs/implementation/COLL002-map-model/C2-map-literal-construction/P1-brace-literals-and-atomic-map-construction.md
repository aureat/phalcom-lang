...
---
# COLL002.C2.P1 — brace literals and atomic map construction

Scope: implementation work with a scoped grammar blocker. Requires B.1 and Spec A.3. B.3a (association Map literals) is dispatchable. B.3b (`{}` as empty Map and bare-brace Set literal completion) is blocked until Phalcom ratifies how those forms coexist with its existing brace block literals.
