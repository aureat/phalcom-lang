# LANG001.C3 — Language runtime stabilization spec
...
- **`phalcom-core/tests/invariants.rs`** — the object-model / metaclass-tower invariant harness (exercised end-to-end via a real `VM`); see [U2](../U2/u2.md), which populated it.
...
## Sources
- forge: [`u0-state.md`](../../archive/phase2/u0-state.md) phase log ("0. Stabilize"), [`u0-plan.md`](../../archive/phase2/u0-plan.md) §"U0 — Front-end stabilization (F9 + F10)".
