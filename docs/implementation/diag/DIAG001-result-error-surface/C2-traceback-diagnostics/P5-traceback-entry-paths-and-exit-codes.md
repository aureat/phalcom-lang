...
---
# DIAG001.C2.P5 — traceback entry paths and exit codes
...
READ FIRST: docs/spec/current/traceback/implementation-spec.md §3.5 + §7; plan.md §T5. graphify before
