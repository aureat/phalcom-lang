...
---
# COLL004.C1.P2 — list mutation and literal construction

Scope: implementation work with two narrowly documented semantic gates. Requires C.1 and C.3. D.1 is recommended first so new List-building code can consistently use `append`, but D.2's literal/compiler work is otherwise separable.
