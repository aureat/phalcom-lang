...
---
# COLL004.C2.P1 — explicit iterator pipeline

Scope: implementation work. Requires D.1's eager direct-operation semantics and the existing bare-cursor iteration protocol.
