...
---
# COLL004.C2.P3 — boundedness and exhaustor diagnostics

Scope: implementation work. Requires E.1 and E.2 for the first complete end-to-end behavior. The analysis should be implemented as a reusable compiler subsystem because Spec F needs the same facts for `*` expansion.
