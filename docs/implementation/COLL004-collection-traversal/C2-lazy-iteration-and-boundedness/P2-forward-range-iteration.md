...
---
# COLL004.C2.P2 — forward range iteration

Scope: implementation work. Requires C.2's Range AST/runtime representation and E.1's explicit Iterator wrapper. This phase deliberately implements only the Range iteration subset already required by the ratified collection/boundedness semantics.
