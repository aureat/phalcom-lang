...
# LANG001.C5.P8 — string protocol and system write funnel
...
> `u0-state.md` (shared coordination docs, concurrent editors) beyond what's explicitly listed below.
...
- **`Iterable` root is NOT landed.** ADR-0048 (Accepted, 2026-07-13) specifies a kernel
  ...
  **U-ITERABLE** — but `../U-ITERABLE/u23-iterable-plan.md` does not exist yet and
