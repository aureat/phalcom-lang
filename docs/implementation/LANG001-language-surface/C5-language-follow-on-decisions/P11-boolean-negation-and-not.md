...
# LANG001.C5.P11 — boolean negation and not

Scope: **PLANNED** (dispatch-ready). Prerequisite/sibling of **U-IS**. Contends
...
## Role
Make `not` the single boolean-negation surface, per [is-tests.md](../../../spec/current/is-tests.md)
...
Also [values-and-absence.md](../../../spec/current/values-and-absence.md) (`Bool#not`, the `.not`
...
- `docs/spec/current/is-tests.md` — strike the implementation-note caveat "not yet wired /
