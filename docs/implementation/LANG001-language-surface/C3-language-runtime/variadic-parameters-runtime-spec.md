# LANG001.C3 — Variadic parameters runtime spec

- **Status:** ✅ Landed — `c9805d0` (runtime + acceptance corpus + forge docs, single commit)
- **Realizes:** [TDR-0011](../../../decisions/accepted/0011-selector-signature-encoding-and-dispatch.md) (amendment — adds the `Variadic` signature kind and `(*)` selector spelling); spec [messages-and-selectors.md §4](../../../spec/current/messages-and-selectors.md)
...
## Sources
- [forge/archive/phase2/STATE.md](../../archive/phase2/u0-state.md) "U9 — LANDED"; [forge/archive/phase2/PHASE2-INDEX.md](../../archive/phase2/PHASE2-INDEX.md).
