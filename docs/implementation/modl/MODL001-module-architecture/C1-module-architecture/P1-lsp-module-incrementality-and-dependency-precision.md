...
# MODL001.C1.P1 — lsp module incrementality and dependency precision

**Record:** implementation plan; lifecycle is recorded in the front matter.
**Program:** Module Incrementality, Dependency Precision, and Semantic Propagation  
**Related scope:** Plan B — IDE Indexing, References, Rename, Retention, and Latency Architecture
