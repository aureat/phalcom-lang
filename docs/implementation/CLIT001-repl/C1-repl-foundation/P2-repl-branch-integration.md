...
---
# CLIT001.C1.P2 — repl branch integration
...
two are already strictly ordered by TDR-0054 and must stay that way. U-REPL merging
...
world from the start — see [§02 §1.4](../C2-repl-session-execution/P1-repl-session-and-cells.md).
...
Stages 0–2 ([§01](P3-repl-compiler-wiring.md), [§02](../C2-repl-session-execution/P1-repl-session-and-cells.md), [§03](../C2-repl-session-execution/P2-repl-cell-immutability.md))
...
**Phase B — branch the rest.** Stages 3–6 ([§04](../C2-repl-session-execution/P3-repl-continuation.md),
[§05](../C3-repl-intelligence/P1-repl-oracle-and-selectors.md), [§06](../C3-repl-intelligence/P2-repl-completion-and-highlighting.md), [§07](../C4-repl-operations/P1-repl-commands.md)) touch
...
This inverts P1-repl-architecture.md's stage order, which put the surface last. The reason is purely
mechanical: P1-repl-architecture.md ordered by *dependency*, this orders by *conflict*. The dependency
...
> [§08](../C4-repl-operations/P2-repl-consolidation.md)'s conflict-resolution table applies. That is the degraded
> path, not the plan.
