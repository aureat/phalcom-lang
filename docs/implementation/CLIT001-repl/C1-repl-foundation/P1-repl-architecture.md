...
# CLIT001.C1.P1 — repl architecture
...
> As specced in `impl/repl-execution-spec.md` delta 2 and `impl/P1-repl-session-and-cells.md §2.2`, the REPL compile mode is represented by a separate orthogonal `UnitKind` enum (`UnitKind::File` vs `UnitKind::Repl`), not a `CompileMode` variant.
...
- **DEC-REPL-A — class redefinition. CLOSED** by
  [TDR-0053](../../../decisions/accepted/0053-classes-are-closed.md) ruling 6: *REPL
...
- **DEC-REPL-B — snippet insertion. CLOSED** by [`repl-completion-and-highlighting-spec.md`](../C3-repl-intelligence/repl-completion-and-highlighting-spec.md) §S7:
...
- **DEC-REPL-C — dead editor stack. CLOSED** by [`repl-completion-and-highlighting-spec.md`](../C3-repl-intelligence/repl-completion-and-highlighting-spec.md) §S8:
...
([`repl-completion-and-highlighting-spec.md`](../C3-repl-intelligence/repl-completion-and-highlighting-spec.md) §S9 — `:reload`, `:reset`, `:help`, only `:reload` built)
