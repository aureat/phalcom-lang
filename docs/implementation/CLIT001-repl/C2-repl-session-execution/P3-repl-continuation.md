...
---
# CLIT001.C2.P3 — repl continuation
...
Rejected (P1-repl-architecture.md §D7): delimiter counting (blind to `let x = 1 +`); Python's `codeop`
...
> **Consequence, accepted in P1-repl-architecture.md §D7:** compiled text ≠ typed text, so byte offsets
