...
---
# CLIT001.C2.P2 — repl cell immutability

Implements P1-repl-architecture.md **§D4**. Two binding sets, and a REPL exemption that relaxes both
...
- **same-scope redeclaration** — `compiler/lib/scope.rs`, documented at `:118`
  ...
  `add_local` does for locals". Class declarations are exempt (TDR-0055 registers
...
Stated in P1-repl-architecture.md §D4 and easy to half-implement. Lifting only the const check leaves
...
The fifth guards ruling 3 of §4 and belongs here rather than in [§02](P1-repl-session-and-cells.md)
