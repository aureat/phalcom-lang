...
---
# CLIT001.C3.P2 — repl completion and highlighting

**Phase B — branch-only.** `phalcom-repl/**` only. The largest stage, and the one the
user actually sees.

Depends on [§05](P1-repl-oracle-and-selectors.md): every layer here reads the snapshot.
...
Depth comes free from [§05 §1.1](P1-repl-oracle-and-selectors.md).
