...
---
# COLL001.C1.P2 — product runtime representation

Scope: implementation work. Requires Spec A.1 landed. This phase builds the canonical runtime substrate without yet replacing the compiler's temporary positional-Tuple bridge or exposing the full new product surface.
