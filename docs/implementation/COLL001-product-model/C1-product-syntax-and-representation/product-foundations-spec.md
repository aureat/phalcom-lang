# COLL001.C1 — Product foundations spec
...
Artifact: `P1-product-syntax-and-ast.md`.
...
Artifact: `P2-product-runtime-representation.md`.
...
Artifact: `../C2-product-construction-and-interoperability/P1-product-construction-and-surface.md`.
