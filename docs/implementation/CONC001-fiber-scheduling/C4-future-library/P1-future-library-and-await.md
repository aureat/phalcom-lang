...
category: CONC
program: CONC001
checkpoint: CONC001.C4
kind: implementation
status: DEFERRED
completion: NOT_STARTED
verification: UNVERIFIED
depends_on: [CONC001.C1.P1, CONC001.C2.P1, CONC001.C3.P1]
follows: CONC001.C1.P1
supersedes: null
deferred_reason: Awaiting the scheduler substrate and Fiber prerequisites.
---

# CONC001.C4.P1 — future library and await

_Self-contained dispatch plan for **one** implementer. Complements the existing
[future-library-spec.md](future-library-spec.md) and
[future-library-architecture-spec.md](future-library-architecture-spec.md),
...
1. **`Fiber#isDone` and `Fiber#error` are NOT landed.** `concurrency.md §1` lists them, but
   ...
   **no `.ph`-observable way to tell "the fiber I just resumed terminated" from "it yielded"**
   ...
   (2026-07-13): spun out to [CONC001.C3.P1](../C3-fiber-reflection/P1-fiber-reflection-and-terminal-state.md)** — both are pure
   ...
   B now **depends on** P4 landing (a precondition, checked at Slice B dispatch)
...
| `P1-future-library-and-await.md` (+ status) | this plan | disjoint |
...
| File | Why |
|---|---|
| — | **Precondition, not this unit's write-set:** `Fiber#isDone`/`error` ship via **[CONC001.C3.P1](../C3-fiber-reflection/P1-fiber-reflection-and-terminal-state.md)** (standalone, unblocked, no scheduler dependency) — Slice B depends on it landing but does not implement it. |
...
4. **Slice B.0 — confirm [CONC001.C3.P1](../C3-fiber-reflection/P1-fiber-reflection-and-terminal-state.md) has landed** (external
...
| Surface, state machine, settle-once | concurrency.md §2; future-library-spec.md §2–§3 |
