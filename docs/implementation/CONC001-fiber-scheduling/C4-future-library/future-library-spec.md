# CONC001.C4 — Future library spec
...
>   [Cooperative Fiber](../C1-fiber-execution/cooperative-fiber-spec.md) on HEAD; confirm the `resumer` link + result
...
sequenced **after [Cooperative Fiber](../C1-fiber-execution/cooperative-fiber-spec.md), before any `Future` method
...
*Cross-links [Cooperative Fiber §7.2](../C1-fiber-execution/cooperative-fiber-spec.md#future-seam).*

`Future` layers over `Fiber` at exactly two [Cooperative Fiber](../C1-fiber-execution/cooperative-fiber-spec.md)
...
`block_call` raises `CannotYieldAcrossNativeFrame` ([Cooperative Fiber §3.2](../C1-fiber-execution/cooperative-fiber-spec.md#restricted-yield)).
