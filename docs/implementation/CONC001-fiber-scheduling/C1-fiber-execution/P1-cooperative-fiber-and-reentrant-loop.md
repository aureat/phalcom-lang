...
# CONC001.C1.P1 — cooperative fiber and reentrant loop
...
- **[CONC001.C3.P1](../C3-fiber-reflection/P1-fiber-reflection-and-terminal-state.md)** — `Fiber#isDone`/`error`, the
  two Interface-table (concurrency.md §1) accessors this unit didn't ship. Needs
  no scheduler; unblocked now.
- **[MEMM001.C1.P1](../../../memm/MEMM001-garbage-collection/C1-gc/P1-garbage-collection.md)** — this unit's own §Rubric flagged "GC roots for
