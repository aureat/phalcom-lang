# CONC001.C3 — Fiber reflection spec

Companion to [`CONC001.C3.P1`](P1-fiber-reflection-and-terminal-state.md) (work order, build order, test strategy,
...
| `../../../../spec/current/concurrency.md` | flip implementation-status note |
| `../../C4-future-library/P1-future-library-and-await.md` | companion edit, §4 |
