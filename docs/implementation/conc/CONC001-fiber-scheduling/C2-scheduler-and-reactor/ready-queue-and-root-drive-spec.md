# CONC001.C2 — Ready queue and root drive spec

Companion to [`CONC001.C2.P1`](P1-ready-queue-and-root-drive.md) (work order, decisions register, test
...
model.** [../C4-future-library/P1-future-library-and-await.md](../C4-future-library/P1-future-library-and-await.md) §6.3/§9 already resolved
...
| `../../../../spec/current/system.md` | flip `schedule(_)` status note; document the additional `nextScheduled` seam as a floor amendment |
| `../../../../spec/current/concurrency.md` | flip Slice B "needs the native ready-queue" note once this lands |

**Deliberately NOT in scope (separate sub-slice, see the Future plan §9):**
...
/// ([CONC001.C3.P1](../C3-fiber-reflection/P1-fiber-reflection-and-terminal-state.md)).
///
