...
follows: null
supersedes: null
deferred_reason: Set-literal grammar must be ratified or implemented by the owning parser work before this backlog can be dispatched.
---

# SEMA004.C1.P11 — semantic capability backlog
