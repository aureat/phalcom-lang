# CLIT001.C3 — Repl completion and highlighting spec

Companion to [`P1-repl-architecture.md`](../C1-repl-foundation/P1-repl-architecture.md), at the same grain. `P1-repl-architecture.md` specs the evaluation
...
> in `P1-repl-architecture.md` must not be weakened: it is the only guard on this interaction.
...
Beyond `P1-repl-architecture.md`'s: `phalcom-repl/src/{completer,highlighter,helper,editor}.rs`
