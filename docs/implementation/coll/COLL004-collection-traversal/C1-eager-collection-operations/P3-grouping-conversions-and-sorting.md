...
---
# COLL004.C1.P3 — grouping conversions and sorting

Scope: implementation work. The grouping/partition/conversion lane is executable after D.1 + B.1/B.2. Sorting is design-ready but MUST remain unshipped until the narrowly listed ordering questions in §13 are ratified.
