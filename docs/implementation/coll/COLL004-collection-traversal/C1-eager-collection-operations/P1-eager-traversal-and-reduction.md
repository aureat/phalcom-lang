...
---
# COLL004.C1.P1 — eager traversal and reduction

Scope: implementation work. Intended to run after Spec C; requires canonical Unit from A. B.2 should be landed first so Map pair traversal can migrate cleanly to `map.entries`.
