...
---
# COLL002.C1.P2 — map views and record interoperability

Scope: implementation work. Requires B.1 and Spec A.3 landed. This phase is pure surface/core-library work over native Map and Record observations unless actual HEAD reveals a missing underivable operation.
