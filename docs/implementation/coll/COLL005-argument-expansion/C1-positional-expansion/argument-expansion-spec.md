# COLL005.C1 — Argument expansion spec

Status: supporting argument-expansion specification. Active work is governed by
the numbered plans and their completion metadata; the rest-capture section
remains future work and does not claim current runtime behavior.
...
Artifact: `../C3-pack-assembly/P1-pack-syntax-and-selector-encoding.md`.
...
Artifact: `../C3-pack-assembly/P2-outgoing-pack-assembly-and-dynamic-send.md`.
...
Artifact: `../C4-expansion-completion/P3-rest-capture-and-pattern-dispatch.md`.
