...
---
# COLL005.C4.P4 — expansion completion
...
`../C3-pack-assembly/P2-outgoing-pack-assembly-and-dynamic-send.md`, sections 36–37, still contains an all-unchecked invariant list even though its completion checklist records the corresponding implementation/tests as complete.
...
`P3-rest-capture-and-pattern-dispatch.md`
