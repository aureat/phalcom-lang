...
---
# COLL003.C2.P2 — range slicing and list replacement

Scope: implementation work. Requires A.3, C.1, and C.2. B.1 is transitively required through C.1. Does not require Spec D/E/F.
