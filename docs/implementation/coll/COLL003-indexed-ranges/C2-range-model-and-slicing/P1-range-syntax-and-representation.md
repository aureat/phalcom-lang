...
---
# COLL003.C2.P1 — range syntax and representation

Scope: implementation work. Requires A.2 for canonical Unit conventions only indirectly; may be implemented after C.1 or in parallel if files do not conflict. C.3 requires this phase.
