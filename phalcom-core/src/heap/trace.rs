...
/// mirror.
pub fn trace_object(obj: &Object, layouts: &crate::product::ProductLayoutRegistry, push: &mut impl FnMut(ObjRef)) {
    match obj {
        ...
        Object::AdtCase(_) | Object::Data(_) => {
            let storage = match obj {
                Object::AdtCase(case) => &case.storage,
