...
//! A block is a first-class lexical closure. It wraps a [`ClosureObject`](crate::closure::ClosureObject)
...
pub struct BlockObject {
    /// Handle to the underlying [`ClosureObject`](crate::closure::ClosureObject).
    pub closure: ObjRef,
