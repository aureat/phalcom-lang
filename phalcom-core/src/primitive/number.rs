...
#[phalcom_native_macros::primitive(Number, "new()", side = class)]
pub fn number_class_new_default(vm: &mut VM, receiver: &Value, _args: &[Value]) -> PhResult<Value> {
    number_class_new(vm, receiver, &[])
}
