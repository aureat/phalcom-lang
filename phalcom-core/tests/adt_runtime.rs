...
#[test]
fn test_enum_singleton_and_constructor_creation() {
    let src = r#"
enum Status {
  @variant Pending
...
#[test]
fn test_bare_singleton_vs_nullary_constructor() {
    let src = r#"
enum CustomOption {
  @variant None
  @variant Nullary()
...
#[test]
fn test_enum_case_payload_reading() {
    let src = r#"
enum Shape {
...
#[test]
fn test_enum_direct_root_instantiation_rejected() {
    let src = r#"
enum Status {
  @variant Pending
  @variant Active(code: Int)
...
#[test]
fn test_enum_case_payload_mutation_rejected() {
    let src = r#"
enum Status {
  @variant Active(code: Int)
}
...
#[test]
fn test_associated_behavioral_invocations() {
    let src = r#"
class MathUtils {
