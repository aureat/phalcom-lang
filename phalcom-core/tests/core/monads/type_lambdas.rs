...
/// MON-LAMBDA-01/02: the Either constructor lambda is canonical, binds `X`, and captures outer `E` as a free declaration parameter.
#[test]
...
/// MON-LAMBDA-03: projecting `EitherMonad<String>` substitutes the captured outer `E` without touching lambda-bound `X`.
#[test]
...
/// MON-LAMBDA-04: applying the constructor obtained from receiver specialization beta-reduces to the proper concrete Either type.
#[test]
