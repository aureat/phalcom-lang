...
- **Case counts:** PASS 75 · NEGATIVE 18 · PENDING 52 · **total 145**.
...
| inheritance | 7 | – | – | `check_pass` | object-model.md §5.1; method-lookup.md §1.14; ADR-0002; ADR-0040 |
...
| compile-errors | – | 7 | – | `check_negative` | values-and-absence.md; ADR-0014; ADR-0007; ADR-0021; object-model.md §5.1 |
